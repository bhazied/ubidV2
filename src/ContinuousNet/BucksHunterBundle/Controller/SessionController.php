...
use ContinuousNet\BucksHunterBundle\Entity\Session;
use ContinuousNet\BucksHunterBundle\Form\SessionType;
...
class SessionController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$sessions = $em->getRepository('BucksHunterBundle:Session')->findAll();

		return $this->render('BucksHunterBundle:Session:index.html.twig', array(
			'sessions' => $sessions,
		));
	}
	...
	{
		$session = new Session();
		$form = $this->createForm('ContinuousNet\BucksHunterBundle\Form\SessionType', $session);
		...
		return $this->render('BucksHunterBundle:Session:new.html.twig', array(
			'session' => $session,
	...
	public function showAction(Session $session)
	{
		...
		return $this->render('BucksHunterBundle:Session:show.html.twig', array(
			'session' => $session,
	...
	{
		$deleteForm = $this->createDeleteForm($session);
		$editForm = $this->createForm('ContinuousNet\BucksHunterBundle\Form\SessionType', $session);
		...
		return $this->render('BucksHunterBundle:Session:edit.html.twig', array(
			'session' => $session,
