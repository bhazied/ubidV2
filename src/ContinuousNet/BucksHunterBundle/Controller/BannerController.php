...
class BannerController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$banners = $em->getRepository('BucksHunterBundle:Banner')->findAll();

		return $this->render('BucksHunterBundle:Banner:index.html.twig', array(
			'banners' => $banners,
		));
	}
	...
	{
		$banner = new Banner();
		$form = $this->createForm('ContinuousNet\BucksHunterBundle\Form\BannerType', $banner);
		...
		return $this->render('BucksHunterBundle:Banner:new.html.twig', array(
			'banner' => $banner,
	...
	public function showAction(Banner $banner)
	{
		...
		return $this->render('BucksHunterBundle:Banner:show.html.twig', array(
			'banner' => $banner,
	...
	{
		$deleteForm = $this->createDeleteForm($banner);
		$editForm = $this->createForm('ContinuousNet\BucksHunterBundle\Form\BannerType', $banner);
		...
		return $this->render('BucksHunterBundle:Banner:edit.html.twig', array(
			'banner' => $banner,
