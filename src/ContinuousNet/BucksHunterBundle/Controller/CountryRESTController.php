...
class CountryRESTController extends BaseRESTController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $qb->from('BucksHunterBundle:Country', 'c_');
            $qb->leftJoin('ContinuousNet\BucksHunterBundle\Entity\User', 'creator_user', \Doctrine\ORM\Query\Expr\Join::WITH, 'c_.creatorUser = creator_user.id');
            $qb->leftJoin('ContinuousNet\BucksHunterBundle\Entity\User', 'modifier_user', \Doctrine\ORM\Query\Expr\Join::WITH, 'c_.modifierUser = modifier_user.id');
            ...
            foreach ($filters as $field => $value) {
                ...
                $_field = str_replace('country.', 'c_.', $field);
            ...
            foreach ($order_by as $field => $direction) {
                $field = str_replace('country.', 'c_.', $field);
