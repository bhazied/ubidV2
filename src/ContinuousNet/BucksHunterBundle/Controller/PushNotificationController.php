...
class PushNotificationController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$pushNotifications = $em->getRepository('BucksHunterBundle:PushNotification')->findAll();

		return $this->render('BucksHunterBundle:PushNotification:index.html.twig', array(
	...
	public function newAction(Request $request)
	{
		...
		$form = $this->createForm('ContinuousNet\BucksHunterBundle\Form\PushNotificationType', $pushNotification);
		...
		return $this->render('BucksHunterBundle:PushNotification:new.html.twig', array(
	...
	public function showAction(PushNotification $pushNotification)
	{
		...
		return $this->render('BucksHunterBundle:PushNotification:show.html.twig', array(
			'pushNotification' => $pushNotification,
	...
	{
		$deleteForm = $this->createDeleteForm($pushNotification);
		$editForm = $this->createForm('ContinuousNet\BucksHunterBundle\Form\PushNotificationType', $pushNotification);
		...
		return $this->render('BucksHunterBundle:PushNotification:edit.html.twig', array(
			'pushNotification' => $pushNotification,
