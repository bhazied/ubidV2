...
use ContinuousNet\BucksHunterBundle\Entity\Banner;
use ContinuousNet\BucksHunterBundle\Form\BannerType;
...
class BannerRESTController extends BaseRESTController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $qb->from('BucksHunterBundle:Banner', 'b_');
            $qb->leftJoin('ContinuousNet\BucksHunterBundle\Entity\Country', 'country', \Doctrine\ORM\Query\Expr\Join::WITH, 'b_.country = country.id');
            $qb->leftJoin('ContinuousNet\BucksHunterBundle\Entity\User', 'creator_user', \Doctrine\ORM\Query\Expr\Join::WITH, 'b_.creatorUser = creator_user.id');
            $qb->leftJoin('ContinuousNet\BucksHunterBundle\Entity\User', 'modifier_user', \Doctrine\ORM\Query\Expr\Join::WITH, 'b_.modifierUser = modifier_user.id');
            $textFields = array('banner.name', 'banner.broughtByText', 'banner.broughtByPicture', 'banner.text', 'banner.picture', 'banner.url');
