...
class SessionRESTController extends BaseRESTController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $qb->from('BucksHunterBundle:Session', 's_');
            ...
            $textFields = array('session.ip', 'session.userAgent');
            foreach ($filters as $field => $value) {
                ...
                $_field = str_replace('session.', 's_.', $field);
            ...
            foreach ($order_by as $field => $direction) {
                $field = str_replace('session.', 's_.', $field);
