...
/**
 * Translation Template Type
 * 
 * Render Translation Template Type 
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationTemplateType
 * @since      Class available since Release 1.0
 * @access     public
 */
class TranslationTemplateType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\BiodyXpertBundle\Entity\TranslationTemplate'
        ));
    }
    ...
    {
        return 'BiodyXpertBundle_TranslationTemplate';
    }
}