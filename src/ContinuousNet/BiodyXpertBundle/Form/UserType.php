...
class UserType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('licence', EntityType::class, array('expanded' => false, 'multiple' => false, 'class' => 'BiodyXpertBundle:Licence', 'choice_label' => 'licenceKey'))
            ->add('deviceSerialNumber', EntityType::class, array('expanded' => false, 'multiple' => false, 'class' => 'BiodyXpertBundle:DeviceSerialNumber', 'choice_label' => 'serialNumber'))
            ->add('serialNumber', TextType::class)
            ->add('language', EntityType::class, array('expanded' => false, 'multiple' => false, 'class' => 'BiodyXpertBundle:Language', 'choice_label' => 'name'))
            ...
            ->add('roles', ChoiceType::class, array('choices' => array('ROLE_API' => 'ROLE_API', 'ROLE_ACCOUNT_USER' => 'ROLE_ACCOUNT_USER', 'ROLE_ACCOUNT_MANAGER' => 'ROLE_ACCOUNT_MANAGER', 'ROLE_ADMIN' => 'ROLE_ADMIN', 'ROLE_SUPER_ADMIN' => 'ROLE_SUPER_ADMIN', ), 'expanded' => true, 'multiple' => true))
            ...
            ->add('groups', EntityType::class, array('expanded' => true, 'multiple' => true, 'class' => 'BiodyXpertBundle:Group', 'choice_label' => 'name'))
        ;
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\BiodyXpertBundle\Entity\User'
        ));
    }
