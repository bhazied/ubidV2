...
class NotificationType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('primaryKey', IntegerType::class)
            ->add('read', CheckboxType::class)
            ->add('fromSuchTime', DateTimeType::class, array('widget' => 'single_text', 'input' => 'datetime'))
        ;
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\BiodyXpertBundle\Entity\Notification'
        ));
    }
    ...
    {
        return 'BiodyXpertBundle_Notification';
    }
}