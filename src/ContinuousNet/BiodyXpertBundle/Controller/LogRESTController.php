...
use ContinuousNet\BiodyXpertBundle\Entity\Log;
use ContinuousNet\BiodyXpertBundle\Form\LogType;
...
class LogRESTController extends BaseRESTController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $qb->from('BiodyXpertBundle:Log', 'l_');
            $qb->leftJoin('ContinuousNet\BiodyXpertBundle\Entity\Session', 'session', \Doctrine\ORM\Query\Expr\Join::WITH, 'l_.session = session.id');
     ...
     * @return Response
     */
    public function putAction(Request $request, Log $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
     ...
     * @return Response
     */
    public function patchAction(Request $request, Log $entity)
    {
     ...
     * @return Response
     */
    public function deleteAction(Request $request, Log $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
