...
/**
 * Translation Pathology REST Controller
 * 
 ...
 * @see      TranslationPathologyRESTController
 * @since      Class available since Release 1.0
 * @access    public
 * @RouteResource("TranslationPathology")
 */
class TranslationPathologyRESTController extends BaseRESTController
{
    /**
     ...
     *
     */
    public function getAction(TranslationPathology $entity)
    {
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $qb->from('BiodyXpertBundle:TranslationPathology', 'tp_');
            $qb->leftJoin('ContinuousNet\BiodyXpertBundle\Entity\Pathology', 'pathology', \Doctrine\ORM\Query\Expr\Join::WITH, 'tp_.pathology = pathology.id');
            $qb->leftJoin('ContinuousNet\BiodyXpertBundle\Entity\User', 'creator_user', \Doctrine\ORM\Query\Expr\Join::WITH, 'tp_.creatorUser = creator_user.id');
            $qb->leftJoin('ContinuousNet\BiodyXpertBundle\Entity\User', 'modifier_user', \Doctrine\ORM\Query\Expr\Join::WITH, 'tp_.modifierUser = modifier_user.id');
            ...
            foreach ($filters as $field => $value) {
                ...
                $_field = str_replace('translationPathology.', 'tp_.', $field);
            ...
            foreach ($order_by as $field => $direction) {
                $field = str_replace('translationPathology.', 'tp_.', $field);
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $entity = new TranslationPathology();
     ...
     * @return Response
     */
    public function putAction(Request $request, TranslationPathology $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
     ...
     * @return Response
     */
    public function patchAction(Request $request, TranslationPathology $entity)
    {
     ...
     * @return Response
     */
    public function deleteAction(Request $request, TranslationPathology $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
