 ...
 * @see      AuthorRESTController
 * @since      Class available since Release 1.0
 * @access    public
 * @RouteResource("Author")
 */
class AuthorRESTController extends BaseRESTController
{
    /**
     * Get a Author entity
     *
     ...
     *
     */
    public function getAction(Author $entity)
    {
    ...
    {
        try {
            $this->createSubDirectory(new Author());
            ...
            $qb->from('BiodyXpertBundle:Author', 'a_');
            ...
            $textFields = array('author.name', 'author.slug');
            ...
            foreach ($filters as $field => $value) {
                ...
                $_field = str_replace('author.', 'a_.', $field);
            ...
            foreach ($order_by as $field => $direction) {
                $field = str_replace('author.', 'a_.', $field);
    ...
    public function postAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $entity = new Author();
        $form = $this->createForm(new AuthorType(), $entity, array('method' => $request->getMethod()));
     ...
     * @return Response
     */
    public function putAction(Request $request, Author $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Author entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, Author $entity)
    {
