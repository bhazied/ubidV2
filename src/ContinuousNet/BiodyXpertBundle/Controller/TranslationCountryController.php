...
use ContinuousNet\BiodyXpertBundle\Entity\TranslationCountry;
use ContinuousNet\BiodyXpertBundle\Form\TranslationCountryType;
...
class TranslationCountryController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$translationCountries = $em->getRepository('BiodyXpertBundle:TranslationCountry')->findAll();

		return $this->render('BiodyXpertBundle:TranslationCountry:index.html.twig', array(
	...
	public function newAction(Request $request)
	{
		...
		$form = $this->createForm('ContinuousNet\BiodyXpertBundle\Form\TranslationCountryType', $translationCountry);
		...
		return $this->render('BiodyXpertBundle:TranslationCountry:new.html.twig', array(
	...
	public function showAction(TranslationCountry $translationCountry)
	{
		...
		return $this->render('BiodyXpertBundle:TranslationCountry:show.html.twig', array(
			'translationCountry' => $translationCountry,
	...
	{
		$deleteForm = $this->createDeleteForm($translationCountry);
		$editForm = $this->createForm('ContinuousNet\BiodyXpertBundle\Form\TranslationCountryType', $translationCountry);
		...
		return $this->render('BiodyXpertBundle:TranslationCountry:edit.html.twig', array(
			'translationCountry' => $translationCountry,
