 ...
 * @see      InstanceRESTController
 * @since      Class available since Release 1.0
 * @access    public
 * @RouteResource("Instance")
 */
class InstanceRESTController extends BaseRESTController
{
    /**
     * Get a Instance entity
     *
    ...
    {
        try {
            $this->createSubDirectory(new Instance());
            ...
            $qb->from('BiodyXpertBundle:Instance', 'i_');
            ...
            $textFields = array('instance.name', 'instance.ip', 'instance.lastVersion', 'instance.url');
            ...
            foreach ($filters as $field => $value) {
                ...
                $_field = str_replace('instance.', 'i_.', $field);
            ...
            foreach ($order_by as $field => $direction) {
                $field = str_replace('instance.', 'i_.', $field);
    ...
    public function postAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $entity = new Instance();
        $form = $this->createForm(new InstanceType(), $entity, array('method' => $request->getMethod()));
     ...
     * @return Response
     */
    public function putAction(Request $request, Instance $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Instance entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, Instance $entity)
    {
        return $this->putAction($request, $entity);
    }

    /**
     * Delete a Instance entity.
     *
     * @View(statusCode=204)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function deleteAction(Request $request, Instance $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
