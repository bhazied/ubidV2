...
class TranslationCountryRESTController extends BaseRESTController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $qb->from('BiodyXpertBundle:TranslationCountry', 'tc_');
            $qb->leftJoin('ContinuousNet\BiodyXpertBundle\Entity\Country', 'country', \Doctrine\ORM\Query\Expr\Join::WITH, 'tc_.country = country.id');
            $qb->leftJoin('ContinuousNet\BiodyXpertBundle\Entity\User', 'creator_user', \Doctrine\ORM\Query\Expr\Join::WITH, 'tc_.creatorUser = creator_user.id');
            $qb->leftJoin('ContinuousNet\BiodyXpertBundle\Entity\User', 'modifier_user', \Doctrine\ORM\Query\Expr\Join::WITH, 'tc_.modifierUser = modifier_user.id');
            ...
            foreach ($filters as $field => $value) {
                ...
                $_field = str_replace('translationCountry.', 'tc_.', $field);
            ...
            foreach ($order_by as $field => $direction) {
                $field = str_replace('translationCountry.', 'tc_.', $field);
