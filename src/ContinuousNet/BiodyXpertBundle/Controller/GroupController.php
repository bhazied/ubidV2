...
use ContinuousNet\BiodyXpertBundle\Entity\Group;
use ContinuousNet\BiodyXpertBundle\Form\GroupType;
...
class GroupController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$groups = $em->getRepository('BiodyXpertBundle:Group')->findAll();

		return $this->render('BiodyXpertBundle:Group:index.html.twig', array(
			'groups' => $groups,
		));
	}
	...
	{
		$group = new Group();
		$form = $this->createForm('ContinuousNet\BiodyXpertBundle\Form\GroupType', $group);
		...
		return $this->render('BiodyXpertBundle:Group:new.html.twig', array(
			'group' => $group,
	...
	public function showAction(Group $group)
	{
		...
		return $this->render('BiodyXpertBundle:Group:show.html.twig', array(
			'group' => $group,
	...
	{
		$deleteForm = $this->createDeleteForm($group);
		$editForm = $this->createForm('ContinuousNet\BiodyXpertBundle\Form\GroupType', $group);
		...
		return $this->render('BiodyXpertBundle:Group:edit.html.twig', array(
			'group' => $group,
