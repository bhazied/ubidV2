...
use ContinuousNet\BiodyXpertBundle\Entity\Language;
use ContinuousNet\BiodyXpertBundle\Form\LanguageType;
...
class LanguageController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$languages = $em->getRepository('BiodyXpertBundle:Language')->findAll();

		return $this->render('BiodyXpertBundle:Language:index.html.twig', array(
			'languages' => $languages,
		));
	}
	...
	public function newAction(Request $request)
	{
		...
		$form = $this->createForm('ContinuousNet\BiodyXpertBundle\Form\LanguageType', $language);
		...
		return $this->render('BiodyXpertBundle:Language:new.html.twig', array(
			'language' => $language,
	...
	public function showAction(Language $language)
	{
		...
		return $this->render('BiodyXpertBundle:Language:show.html.twig', array(
			'language' => $language,
	...
	{
		$deleteForm = $this->createDeleteForm($language);
		$editForm = $this->createForm('ContinuousNet\BiodyXpertBundle\Form\LanguageType', $language);
		...
		return $this->render('BiodyXpertBundle:Language:edit.html.twig', array(
			'language' => $language,
