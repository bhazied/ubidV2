...
class LogController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$logs = $em->getRepository('BiodyXpertBundle:Log')->findAll();

		return $this->render('BiodyXpertBundle:Log:index.html.twig', array(
			'logs' => $logs,
		));
	}
	...
	{
		$log = new Log();
		$form = $this->createForm('ContinuousNet\BiodyXpertBundle\Form\LogType', $log);
		...
		return $this->render('BiodyXpertBundle:Log:new.html.twig', array(
			'log' => $log,
	...
	public function showAction(Log $log)
	{
		...
		return $this->render('BiodyXpertBundle:Log:show.html.twig', array(
			'log' => $log,
	...
	{
		$deleteForm = $this->createDeleteForm($log);
		$editForm = $this->createForm('ContinuousNet\BiodyXpertBundle\Form\LogType', $log);
		...
		return $this->render('BiodyXpertBundle:Log:edit.html.twig', array(
			'log' => $log,
