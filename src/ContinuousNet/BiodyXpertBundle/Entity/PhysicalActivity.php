...
class PhysicalActivity 
{
     ...
     * @access private
     *
     * @ORM\Column(name="`energy_needs_rate`", type="integer", nullable=true, unique=false)
     * 
     * @Expose
     * 
     */
     ...
     *
     * @access public
     * @param integer $energyNeedsRate
     * @return PhysicalActivity
     */
    public function setEnergyNeedsRate($energyNeedsRate = null)
    {
