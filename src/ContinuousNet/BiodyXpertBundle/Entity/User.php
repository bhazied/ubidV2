 ...
 * @access     public
 * 
 * @ORM\Table(name="`user`", indexes={@ORM\Index(name="country_id", columns={"country_id"}), @ORM\Index(name="licence_id", columns={"licence_id"}), @ORM\Index(name="device_serial_number_id", columns={"device_serial_number_id"}), @ORM\Index(name="language_id", columns={"language_id"}), @ORM\Index(name="creator_user_id", columns={"creator_user_id"}), @ORM\Index(name="modifier_user_id", columns={"modifier_user_id"})})
 * @ORM\Entity
...
class User  extends BaseUser
{
     ...
     * @access protected
     *
     * @ORM\Column(name="`serial_number`", type="string", length=250, nullable=true, unique=false)
     * 
     * @Expose
     * 
     */
    ...
    /**
     * @var \ContinuousNet\BiodyXpertBundle\Entity\DeviceSerialNumber
     * @access protected
     *
     * @ORM\ManyToOne(targetEntity="DeviceSerialNumber")
     * @ORM\JoinColumns({
     ...
     * 
     */
    protected $deviceSerialNumber;

    /**
     * @var \ContinuousNet\BiodyXpertBundle\Entity\Language
     * @access protected
     *
     ...
     *
     * @access public
     * @param \ContinuousNet\BiodyXpertBundle\Entity\DeviceSerialNumber $deviceSerialNumber
     * @return User
     */
    public function setDeviceSerialNumber(DeviceSerialNumber $deviceSerialNumber = null)
    {
     ...
     *
     * @access public
     * @return \ContinuousNet\BiodyXpertBundle\Entity\DeviceSerialNumber 
     */
     ...
     *
     * @access public
     * @param \ContinuousNet\BiodyXpertBundle\Entity\Language $language
     * @return User
     */
     ...
     *
     * @access public
     * @return \ContinuousNet\BiodyXpertBundle\Entity\Language 
     */
