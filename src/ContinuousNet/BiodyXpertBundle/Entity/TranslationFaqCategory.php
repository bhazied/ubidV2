...
/**
 * Translation Faq Category Entity
 * 
 * Storing TranslationFaqCategories data to the database using Doctrine
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationFaqCategory
 * @since      Class available since Release 1.0
 * @access     public
 * 
 * @ORM\Table(name="`translation_faq_category`", indexes={@ORM\Index(name="faq_category_id", columns={"faq_category_id"}), @ORM\Index(name="creator_user_id", columns={"creator_user_id"}), @ORM\Index(name="modifier_user_id", columns={"modifier_user_id"})})
 * @ORM\Entity
...
class TranslationFaqCategory 
{
    ...
    /**
     * @var \ContinuousNet\BiodyXpertBundle\Entity\FaqCategory
     * @access private
     *
     ...
     *
     * @access public
     * @param \ContinuousNet\BiodyXpertBundle\Entity\FaqCategory $faqCategory
     * @return TranslationFaqCategory
     */
     ...
     *
     * @access public
     * @return \ContinuousNet\BiodyXpertBundle\Entity\FaqCategory 
     */
