...
/**
 * Translation Indicator Type Entity
 * 
 * Storing TranslationIndicatorTypes data to the database using Doctrine
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationIndicatorType
 * @since      Class available since Release 1.0
 * @access     public
 * 
 * @ORM\Table(name="`translation_indicator_type`", indexes={@ORM\Index(name="indicator_type_id", columns={"indicator_type_id"}), @ORM\Index(name="creator_user_id", columns={"creator_user_id"}), @ORM\Index(name="modifier_user_id", columns={"modifier_user_id"})})
 * @ORM\Entity
 ...
 * 
 */
class TranslationIndicatorType 
{
    /**
     * @var integer
     * @access private
     ...
     * @access public
     * @param string $locale
     * @return TranslationIndicatorType
     */
