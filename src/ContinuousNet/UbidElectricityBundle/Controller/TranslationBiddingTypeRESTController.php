...
class TranslationBiddingTypeRESTController extends BaseRESTController
{
    ...
    {
        try {
            $dir = $this->getSubDirectory(new TranslationBiddingType(), false);
            ...
            $qb->from('UbidElectricityBundle:TranslationBiddingType', 'tbt_');
            $qb->leftJoin('ContinuousNet\UbidElectricityBundle\Entity\BiddingType', 'bidding_type', \Doctrine\ORM\Query\Expr\Join::WITH, 'tbt_.biddingType = bidding_type.id');
            ...
            foreach ($filters as $field => $value) {
                ...
                $_field = str_replace('translationBiddingType.', 'tbt_.', $field);
            ...
            foreach ($order_by as $field => $direction) {
                $field = str_replace('translationBiddingType.', 'tbt_.', $field);
