...
class PostTypeController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$postTypes = $em->getRepository('UbidElectricityBundle:PostType')->findAll();

		return $this->render('UbidElectricityBundle:PostType:index.html.twig', array(
			'postTypes' => $postTypes,
		));
	}
	...
	public function newAction(Request $request)
	{
		...
		$form = $this->createForm('ContinuousNet\UbidElectricityBundle\Form\PostTypeType', $postType);
		...
		return $this->render('UbidElectricityBundle:PostType:new.html.twig', array(
			'postType' => $postType,
	...
	public function showAction(PostType $postType)
	{
		...
		return $this->render('UbidElectricityBundle:PostType:show.html.twig', array(
			'postType' => $postType,
	...
	{
		$deleteForm = $this->createDeleteForm($postType);
		$editForm = $this->createForm('ContinuousNet\UbidElectricityBundle\Form\PostTypeType', $postType);
		...
		return $this->render('UbidElectricityBundle:PostType:edit.html.twig', array(
			'postType' => $postType,
