 ...
 * @see      BidRESTController
 * @since      Class available since Release 1.0
 * @access    public
 * @RouteResource("Bid")
 */
class BidRESTController extends BaseRESTController
{
    /**
     * Get a Bid entity
     *
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $textFields = array('bid.title', 'bid.slug', 'bid.reference', 'bid.description', 'bid.note', 'bid.address', 'bid.email', 'bid.phone', 'bid.attachmentFile1', 'bid.attachmentFile2', 'bid.attachmentFile3', 'bid.attachmentFile4');
    ...
    public function postAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $entity = new Bid();
        $form = $this->createForm(new BidType(), $entity, array('method' => $request->getMethod()));
     ...
     * @return Response
     */
    public function putAction(Request $request, Bid $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Bid entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, Bid $entity)
    {
     ...
     * @return Response
     */
    public function deleteAction(Request $request, Bid $entity)
    {
        try {
            $roles = $this->getUser()->getRoles();
            if (!empty($roles)) {
