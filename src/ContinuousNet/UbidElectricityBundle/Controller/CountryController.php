...
class CountryController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$countries = $em->getRepository('UbidElectricityBundle:Country')->findAll();

		return $this->render('UbidElectricityBundle:Country:index.html.twig', array(
			'countries' => $countries,
		));
	}
	...
	{
		$country = new Country();
		$form = $this->createForm('ContinuousNet\UbidElectricityBundle\Form\CountryType', $country);
		...
		return $this->render('UbidElectricityBundle:Country:new.html.twig', array(
			'country' => $country,
	...
	public function showAction(Country $country)
	{
		...
		return $this->render('UbidElectricityBundle:Country:show.html.twig', array(
			'country' => $country,
	...
	{
		$deleteForm = $this->createDeleteForm($country);
		$editForm = $this->createForm('ContinuousNet\UbidElectricityBundle\Form\CountryType', $country);
		...
		return $this->render('UbidElectricityBundle:Country:edit.html.twig', array(
			'country' => $country,
