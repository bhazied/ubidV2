...
class CategoryRESTController extends BaseRESTController
{
    ...
    {
        try {
            $dir = $this->getSubDirectory(new Category(), false);
            ...
            $qb->leftJoin('ContinuousNet\UbidElectricityBundle\Entity\Category', 'parent_category', \Doctrine\ORM\Query\Expr\Join::WITH, 'c_.parentCategory = parent_category.id');
            ...
            $textFields = array('category.name', 'category.slug', 'category.picture', 'category.description');
