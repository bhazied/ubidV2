...
class CategoryRESTController extends BaseRESTController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $qb->leftJoin('ContinuousNet\UbidElectricityBundle\Entity\Category', 'parent', \Doctrine\ORM\Query\Expr\Join::WITH, 'c_.parent = parent.id');
            ...
            $textFields = array('category.name', 'category.nameAr', 'category.nameFr', 'category.slug', 'category.slugAr', 'category.slugFr', 'category.picture', 'category.description', 'category.descriptionAr', 'category.descriptionFr');
            foreach ($filters as $field => $value) {
                ...
                $_field = str_replace('category.', 'c_.', $field);
            ...
            foreach ($order_by as $field => $direction) {
                $field = str_replace('category.', 'c_.', $field);
