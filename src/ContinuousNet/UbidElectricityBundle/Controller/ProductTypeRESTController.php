 ...
 * @see      ProductTypeRESTController
 * @since      Class available since Release 1.0
 * @access    public
 * @RouteResource("ProductType")
 */
class ProductTypeRESTController extends BaseRESTController
{
    /**
     * Get a Product Type entity
     *
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $textFields = array('productType.name', 'productType.nameAr', 'productType.nameFr', 'productType.slug', 'productType.slugAr', 'productType.slugFr');
    ...
    public function postAction(Request $request)
    {
        ...
        $form = $this->createForm(new ProductTypeType(), $entity, array('method' => $request->getMethod()));
     ...
     * @return Response
     */
    public function putAction(Request $request, ProductType $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Product Type entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, ProductType $entity)
    {
        return $this->putAction($request, $entity);
    }

    /**
     * Delete a Product Type entity.
     *
     * @View(statusCode=204)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function deleteAction(Request $request, ProductType $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
