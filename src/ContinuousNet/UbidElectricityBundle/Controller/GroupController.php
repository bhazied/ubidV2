...
class GroupController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$groups = $em->getRepository('UbidElectricityBundle:Group')->findAll();

		return $this->render('UbidElectricityBundle:Group:index.html.twig', array(
			'groups' => $groups,
		));
	}
	...
	{
		$group = new Group();
		$form = $this->createForm('ContinuousNet\UbidElectricityBundle\Form\GroupType', $group);
		...
		return $this->render('UbidElectricityBundle:Group:new.html.twig', array(
			'group' => $group,
	...
	public function showAction(Group $group)
	{
		...
		return $this->render('UbidElectricityBundle:Group:show.html.twig', array(
			'group' => $group,
	...
	{
		$deleteForm = $this->createDeleteForm($group);
		$editForm = $this->createForm('ContinuousNet\UbidElectricityBundle\Form\GroupType', $group);
		...
		return $this->render('UbidElectricityBundle:Group:edit.html.twig', array(
			'group' => $group,
