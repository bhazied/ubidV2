...
use ContinuousNet\UbidElectricityBundle\Entity\PostCategory;
use ContinuousNet\UbidElectricityBundle\Form\PostCategoryType;
...
class PostCategoryController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$postCategories = $em->getRepository('UbidElectricityBundle:PostCategory')->findAll();

		return $this->render('UbidElectricityBundle:PostCategory:index.html.twig', array(
	...
	public function newAction(Request $request)
	{
		...
		$form = $this->createForm('ContinuousNet\UbidElectricityBundle\Form\PostCategoryType', $postCategory);
		...
		return $this->render('UbidElectricityBundle:PostCategory:new.html.twig', array(
	...
	public function showAction(PostCategory $postCategory)
	{
		...
		return $this->render('UbidElectricityBundle:PostCategory:show.html.twig', array(
			'postCategory' => $postCategory,
	...
	{
		$deleteForm = $this->createDeleteForm($postCategory);
		$editForm = $this->createForm('ContinuousNet\UbidElectricityBundle\Form\PostCategoryType', $postCategory);
		...
		return $this->render('UbidElectricityBundle:PostCategory:edit.html.twig', array(
			'postCategory' => $postCategory,
