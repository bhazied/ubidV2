...
class ClickController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$clicks = $em->getRepository('UbidElectricityBundle:Click')->findAll();

		return $this->render('UbidElectricityBundle:Click:index.html.twig', array(
			'clicks' => $clicks,
		));
	}
	...
	{
		$click = new Click();
		$form = $this->createForm('ContinuousNet\UbidElectricityBundle\Form\ClickType', $click);
		...
		return $this->render('UbidElectricityBundle:Click:new.html.twig', array(
			'click' => $click,
	...
	public function showAction(Click $click)
	{
		...
		return $this->render('UbidElectricityBundle:Click:show.html.twig', array(
			'click' => $click,
	...
	{
		$deleteForm = $this->createDeleteForm($click);
		$editForm = $this->createForm('ContinuousNet\UbidElectricityBundle\Form\ClickType', $click);
		...
		return $this->render('UbidElectricityBundle:Click:edit.html.twig', array(
			'click' => $click,
