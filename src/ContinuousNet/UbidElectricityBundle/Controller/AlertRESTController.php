...
class AlertRESTController extends BaseRESTController
{
    ...
    {
        try {
            $dir = $this->getSubDirectory(new Alert(), false);
            ...
            $qb->leftJoin('ContinuousNet\UbidElectricityBundle\Entity\Category', 'category', \Doctrine\ORM\Query\Expr\Join::WITH, 'a_.category = category.id');
            ...
            $textFields = array('alert.name', 'alert.description');
