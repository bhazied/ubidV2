...
class NotificationController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$notifications = $em->getRepository('UbidElectricityBundle:Notification')->findAll();

		return $this->render('UbidElectricityBundle:Notification:index.html.twig', array(
	...
	public function newAction(Request $request)
	{
		...
		$form = $this->createForm('ContinuousNet\UbidElectricityBundle\Form\NotificationType', $notification);
		...
		return $this->render('UbidElectricityBundle:Notification:new.html.twig', array(
	...
	public function showAction(Notification $notification)
	{
		...
		return $this->render('UbidElectricityBundle:Notification:show.html.twig', array(
			'notification' => $notification,
	...
	{
		$deleteForm = $this->createDeleteForm($notification);
		$editForm = $this->createForm('ContinuousNet\UbidElectricityBundle\Form\NotificationType', $notification);
		...
		return $this->render('UbidElectricityBundle:Notification:edit.html.twig', array(
			'notification' => $notification,
