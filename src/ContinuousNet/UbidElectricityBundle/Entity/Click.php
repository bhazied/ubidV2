 ...
 * Click Entity
 * 
 * Storing Clicks data to the database using Doctrine
 * 
 * PHP version 5.4.4
 * 
 ...
 * @access     public
 * 
 * @ORM\Table(name="`click`", indexes={@ORM\Index(name="visit_id", columns={"visit_id"}), @ORM\Index(name="banner_id", columns={"banner_id"}), @ORM\Index(name="creator_user_id", columns={"creator_user_id"})})
 * @ORM\Entity
...
class Click 
{
    ...
    /**
     * @var \ContinuousNet\UbidElectricityBundle\Entity\Visit
     * @access private
     *
    ...
    /**
     * @var \ContinuousNet\UbidElectricityBundle\Entity\Banner
     * @access private
     *
     ...
     *
     * @access public
     * @param \ContinuousNet\UbidElectricityBundle\Entity\Visit $visit
     * @return Click
     */
     ...
     *
     * @access public
     * @return \ContinuousNet\UbidElectricityBundle\Entity\Visit 
     */
     ...
     *
     * @access public
     * @param \ContinuousNet\UbidElectricityBundle\Entity\Banner $banner
     * @return Click
     */
     ...
     *
     * @access public
     * @return \ContinuousNet\UbidElectricityBundle\Entity\Banner 
     */
