...
/**
 * Translation Supplier Type Entity
 * 
 * Storing TranslationSupplierTypes data to the database using Doctrine
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationSupplierType
 * @since      Class available since Release 1.0
 * @access     public
 * 
 * @ORM\Table(name="`translation_supplier_type`", indexes={@ORM\Index(name="supplier_type_id", columns={"supplier_type_id"}), @ORM\Index(name="creator_user_id", columns={"creator_user_id"}), @ORM\Index(name="modifier_user_id", columns={"modifier_user_id"})})
 * @ORM\Entity
...
class TranslationSupplierType 
{
     ...
     * @access public
     * @param string $locale
     * @return TranslationSupplierType
     */
