...
/**
 * Translation Bidding Type Entity
 * 
 * Storing TranslationBiddingTypes data to the database using Doctrine
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationBiddingType
 * @since      Class available since Release 1.0
 * @access     public
 * 
 * @ORM\Table(name="`translation_bidding_type`", indexes={@ORM\Index(name="bidding_type_id", columns={"bidding_type_id"}), @ORM\Index(name="creator_user_id", columns={"creator_user_id"}), @ORM\Index(name="modifier_user_id", columns={"modifier_user_id"})})
 * @ORM\Entity
