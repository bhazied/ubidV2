...
/**
 * Translation Region Entity
 * 
 * Storing TranslationRegions data to the database using Doctrine
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationRegion
 * @since      Class available since Release 1.0
 * @access     public
 * 
 * @ORM\Table(name="`translation_region`", indexes={@ORM\Index(name="region_id", columns={"region_id"}), @ORM\Index(name="creator_user_id", columns={"creator_user_id"}), @ORM\Index(name="modifier_user_id", columns={"modifier_user_id"})})
 * @ORM\Entity
