...
/**
 * Translation Sector Entity
 * 
 * Storing TranslationSectors data to the database using Doctrine
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationSector
 * @since      Class available since Release 1.0
 * @access     public
 * 
 * @ORM\Table(name="`translation_sector`", indexes={@ORM\Index(name="sector_id", columns={"sector_id"}), @ORM\Index(name="creator_user_id", columns={"creator_user_id"}), @ORM\Index(name="modifier_user_id", columns={"modifier_user_id"})})
 * @ORM\Entity
