...
/**
 * Translation Product Type Entity
 * 
 * Storing TranslationProductTypes data to the database using Doctrine
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationProductType
 * @since      Class available since Release 1.0
 * @access     public
 * 
 * @ORM\Table(name="`translation_product_type`", indexes={@ORM\Index(name="product_type_id", columns={"product_type_id"}), @ORM\Index(name="creator_user_id", columns={"creator_user_id"}), @ORM\Index(name="modifier_user_id", columns={"modifier_user_id"})})
 * @ORM\Entity
