...
/**
 * Translation Menu Type
 * 
 * Render Translation Menu Type 
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationMenuType
 * @since      Class available since Release 1.0
 * @access     public
 */
class TranslationMenuType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\UbidElectricityBundle\Entity\TranslationMenu'
        ));
    }
    ...
    {
        return 'UbidElectricityBundle_TranslationMenu';
    }
}