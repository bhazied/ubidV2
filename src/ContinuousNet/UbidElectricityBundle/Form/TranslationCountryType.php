...
/**
 * Translation Country Type
 * 
 * Render Translation Country Type 
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationCountryType
 * @since      Class available since Release 1.0
 * @access     public
 */
class TranslationCountryType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\UbidElectricityBundle\Entity\TranslationCountry'
        ));
    }
    ...
    {
        return 'UbidElectricityBundle_TranslationCountry';
    }
}