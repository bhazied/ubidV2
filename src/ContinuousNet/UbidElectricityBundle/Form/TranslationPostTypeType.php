...
/**
 * Translation Post Type Type
 * 
 * Render Translation Post Type Type 
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationPostTypeType
 * @since      Class available since Release 1.0
 * @access     public
 */
class TranslationPostTypeType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\UbidElectricityBundle\Entity\TranslationPostType'
        ));
    }
    ...
    {
        return 'UbidElectricityBundle_TranslationPostType';
    }
}