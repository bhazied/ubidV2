...
/**
 * Tender Bookmark Type
 * 
 * Render Tender Bookmark Type 
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TenderBookmarkType
 * @since      Class available since Release 1.0
 * @access     public
 */
class TenderBookmarkType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\UbidElectricityBundle\Entity\TenderBookmark'
        ));
    }
    ...
    {
        return 'UbidElectricityBundle_TenderBookmark';
    }
}