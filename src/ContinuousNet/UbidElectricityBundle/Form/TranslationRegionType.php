...
/**
 * Translation Region Type
 * 
 * Render Translation Region Type 
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationRegionType
 * @since      Class available since Release 1.0
 * @access     public
 */
class TranslationRegionType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\UbidElectricityBundle\Entity\TranslationRegion'
        ));
    }
    ...
    {
        return 'UbidElectricityBundle_TranslationRegion';
    }
}