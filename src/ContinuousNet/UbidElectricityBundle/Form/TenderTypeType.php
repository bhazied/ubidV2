 ...
 * @access     public
 */
class TenderTypeType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\UbidElectricityBundle\Entity\TenderType'
        ));
    }
    ...
    {
        return 'UbidElectricityBundle_TenderType';
    }
}