 ...
 * 
 * Render Translation Product Type Type 
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationProductTypeType
 * @since      Class available since Release 1.0
 * @access     public
 */
class TranslationProductTypeType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\UbidElectricityBundle\Entity\TranslationProductType'
        ));
    }
    ...
    {
        return 'UbidElectricityBundle_TranslationProductType';
    }
}