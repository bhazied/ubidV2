...
/**
 * Translation Supplier Type Type
 * 
 * Render Translation Supplier Type Type 
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationSupplierTypeType
 * @since      Class available since Release 1.0
 * @access     public
 */
class TranslationSupplierTypeType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\UbidElectricityBundle\Entity\TranslationSupplierType'
        ));
    }
    ...
    {
        return 'UbidElectricityBundle_TranslationSupplierType';
    }
}