...
/**
 * Translation Buyer Type Type
 * 
 * Render Translation Buyer Type Type 
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationBuyerTypeType
 * @since      Class available since Release 1.0
 * @access     public
 */
class TranslationBuyerTypeType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\UbidElectricityBundle\Entity\TranslationBuyerType'
        ));
    }
    ...
    {
        return 'UbidElectricityBundle_TranslationBuyerType';
    }
}