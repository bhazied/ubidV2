...
/**
 * Translation Tender Type Type
 * 
 * Render Translation Tender Type Type 
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationTenderTypeType
 * @since      Class available since Release 1.0
 * @access     public
 */
class TranslationTenderTypeType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\UbidElectricityBundle\Entity\TranslationTenderType'
        ));
    }
    ...
    {
        return 'UbidElectricityBundle_TranslationTenderType';
    }
}