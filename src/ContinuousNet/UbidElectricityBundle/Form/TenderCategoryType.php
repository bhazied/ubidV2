 ...
 * @see        TenderCategoryType
 * @since      Class available since Release 1.0
 * @access     public
 */
class TenderCategoryType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('parent', EntityType::class, array('expanded' => false, 'multiple' => false, 'class' => 'UbidElectricityBundle:TenderCategory', 'choice_label' => 'name'))
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\UbidElectricityBundle\Entity\TenderCategory'
        ));
    }
    ...
    {
        return 'UbidElectricityBundle_TenderCategory';
    }
}