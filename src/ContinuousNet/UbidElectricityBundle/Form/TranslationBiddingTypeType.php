...
/**
 * Translation Bidding Type Type
 * 
 * Render Translation Bidding Type Type 
 * 
 * PHP version 5.4.4
 * 
 ...
 * @see        TranslationBiddingTypeType
 * @since      Class available since Release 1.0
 * @access     public
 */
class TranslationBiddingTypeType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\UbidElectricityBundle\Entity\TranslationBiddingType'
        ));
    }
    ...
    {
        return 'UbidElectricityBundle_TranslationBiddingType';
    }
}