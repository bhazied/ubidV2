...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $visitsDataFactory, $bannersDataFactory, $usersDataFactory, $clicksDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            { field: 'id', title: $filter('translate')('content.list.fields.ID'), sortable: 'click.id', filter: { 'click.id': 'number' }, displayInList: true, getValue: $scope.textValue },
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'click.createdAt', filter: { 'click.createdAt': 'number' }, displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'banner', 'class': 'has_one', title: $filter('translate')('content.list.fields.BANNER'), sortable: 'banner.name', filter: { 'click.banner': 'select' }, getValue: $scope.linkValue, filterData: $scope.getBanners(), displayInList: true, displayField: 'name', state: 'app.adserving.bannersdetails' },
            { field: 'creator_user', 'class': 'has_one', title: $filter('translate')('content.list.fields.CREATORUSER'), sortable: 'creator_user.username', filter: { 'click.creatorUser': 'select' }, getValue: $scope.linkValue, filterData: $scope.getUsers(), displayInList: true, displayField: 'username', state: 'app.access.usersdetails' },
            { field: 'visit', 'class': 'has_one', title: $filter('translate')('content.list.fields.VISIT'), sortable: 'visit.ip', filter: { 'click.visit': 'select' }, getValue: $scope.linkValue, filterData: $scope.getVisits(), displayInList: true, displayField: 'ip', state: 'app.statistics.visitsdetails' },
