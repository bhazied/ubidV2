...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $visitsDataFactory, $bannersDataFactory, $usersDataFactory, $clicksDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            ...
            { field: 'banner', 'class': 'has_one', title: $filter('translate')('content.list.fields.BANNER'), sortable: 'banner.name', filter: { 'click.banner': 'select' }, getValue: $scope.linkValue, filterData: $scope.getBanners(), show: $scope.getParamValue('banner_id_show_filed', true), displayField: 'name', state: 'app.adserving.bannersdetails' },
            ...
            { field: 'visit', 'class': 'has_one', title: $filter('translate')('content.list.fields.VISIT'), sortable: 'visit.ip', filter: { 'click.visit': 'select' }, getValue: $scope.linkValue, filterData: $scope.getVisits(), show: $scope.getParamValue('visit_id_show_filed', true), displayField: 'ip', state: 'app.statistics.visitsdetails' },
