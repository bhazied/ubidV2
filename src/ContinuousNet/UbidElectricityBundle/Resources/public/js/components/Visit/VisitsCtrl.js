...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $usersDataFactory, $visitsDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            { field: 'id', title: $filter('translate')('content.list.fields.ID'), sortable: 'visit.id', filter: { 'visit.id': 'number' }, show: $scope.getParamValue('id_show_filed', true), displayInList: true, getValue: $scope.textValue },
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'visit.createdAt', filter: { 'visit.createdAt': 'number' }, show: $scope.getParamValue('created_at_show_filed', true), displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'modified_at', title: $filter('translate')('content.list.fields.MODIFIEDAT'), sortable: 'visit.modifiedAt', filter: { 'visit.modifiedAt': 'number' }, show: $scope.getParamValue('modified_at_show_filed', true), displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'user_agent', title: $filter('translate')('content.list.fields.USERAGENT'), sortable: 'visit.userAgent', filter: { 'visit.userAgent': 'text' }, show: $scope.getParamValue('user_agent_show_filed', false), displayInList: true, getValue: $scope.textValue },
            { field: 'ip', title: $filter('translate')('content.list.fields.IP'), sortable: 'visit.ip', filter: { 'visit.ip': 'text' }, show: $scope.getParamValue('ip_show_filed', true), displayInList: true, getValue: $scope.textValue },
            { field: 'is_valid', title: $filter('translate')('content.list.fields.ISVALID'), sortable: 'visit.isValid', filter: { 'visit.isValid': 'select' }, show: $scope.getParamValue('is_valid_show_filed', true), displayInList: true, getValue: $scope.interpolatedValue, filterData : $scope.booleanOptions, interpolateExpr: $interpolate('<span my-boolean="[[ row.is_valid ]]"></span>') },
            ...
            { field: 'modifier_user', 'class': 'has_one', title: $filter('translate')('content.list.fields.MODIFIERUSER'), sortable: 'modifier_user.username', filter: { 'visit.modifierUser': 'select' }, getValue: $scope.linkValue, filterData: $scope.getUsers(), show: $scope.getParamValue('modifier_user_id_show_filed', false), displayInList: true, displayField: 'username', state: 'app.access.usersdetails' },
