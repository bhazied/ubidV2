...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $tendersDataFactory, $categoriesDataFactory, $productTypesDataFactory, $usersDataFactory, $tenderProductsDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            ...
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'tenderProduct.createdAt', filter: { 'tenderProduct.createdAt': 'number' }, show: $scope.getParamValue('created_at_show_filed', true), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            ...
            { field: 'duration', title: $filter('translate')('content.list.fields.DURATION'), sortable: 'tenderProduct.duration', filter: { 'tenderProduct.duration': 'number' }, show: $scope.getParamValue('duration_show_filed', true), getValue: $scope.textValue },
            { field: 'modified_at', title: $filter('translate')('content.list.fields.MODIFIEDAT'), sortable: 'tenderProduct.modifiedAt', filter: { 'tenderProduct.modifiedAt': 'number' }, show: $scope.getParamValue('modified_at_show_filed', true), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'quantity', title: $filter('translate')('content.list.fields.QUANTITY'), sortable: 'tenderProduct.quantity', filter: { 'tenderProduct.quantity': 'number' }, show: $scope.getParamValue('quantity_show_filed', true), getValue: $scope.textValue },
            { field: 'unit_cost', title: $filter('translate')('content.list.fields.UNITCOST'), sortable: 'tenderProduct.unitCost', filter: { 'tenderProduct.unitCost': 'number' }, show: $scope.getParamValue('unit_cost_show_filed', true), getValue: $scope.textValue },
            { field: 'ordering', title: $filter('translate')('content.list.fields.ORDERING'), sortable: 'tenderProduct.ordering', filter: { 'tenderProduct.ordering': 'number' }, show: $scope.getParamValue('ordering_show_filed', false), getValue: $scope.textValue },
            ...
            { field: 'status', 'class': 'enum', title: $filter('translate')('content.list.fields.STATUS'), sortable: 'tenderProduct.status', filter: { 'tenderProduct.status': 'select' }, show: $scope.getParamValue('status_show_filed', false), getValue: $scope.interpolatedValue, filterData : $scope.statusesOptions, interpolateExpr: $interpolate('<span class="tenderProductStatus" my-enum="[[ row.status ]]" my-enum-list=\'[[ statuses ]]\'></span>') },
            { field: 'title', title: $filter('translate')('content.list.fields.TITLE'), sortable: 'tenderProduct.title', filter: { 'tenderProduct.title': 'text' }, show: $scope.getParamValue('title_show_filed', false), getValue: $scope.textValue },
            { field: 'category', 'class': 'has_one', title: $filter('translate')('content.list.fields.CATEGORY'), sortable: 'category.name', filter: { 'tenderProduct.category': 'select' }, getValue: $scope.linkValue, filterData: $scope.getCategories(), show: $scope.getParamValue('category_id_show_filed', false), displayField: 'name', state: 'app.lists.categoriesdetails' },
            ...
            { field: 'modifier_user', 'class': 'has_one', title: $filter('translate')('content.list.fields.MODIFIERUSER'), sortable: 'modifier_user.username', filter: { 'tenderProduct.modifierUser': 'select' }, getValue: $scope.linkValue, filterData: $scope.getUsers(), show: $scope.getParamValue('modifier_user_id_show_filed', false), displayField: 'username', state: 'app.access.usersdetails' },
            { field: 'product_type', 'class': 'has_one', title: $filter('translate')('content.list.fields.PRODUCTTYPE'), sortable: 'product_type.name', filter: { 'tenderProduct.productType': 'select' }, getValue: $scope.linkValue, filterData: $scope.getProductTypes(), show: $scope.getParamValue('product_type_id_show_filed', false), displayField: 'name', state: 'app.lists.producttypesdetails' },
            { field: 'tender', 'class': 'has_one', title: $filter('translate')('content.list.fields.TENDER'), sortable: 'tender.title', filter: { 'tenderProduct.tender': 'select' }, getValue: $scope.linkValue, filterData: $scope.getTenders(), show: $scope.getParamValue('tender_id_show_filed', false), displayField: 'title', state: 'app.marketplace.tendersdetails' },
