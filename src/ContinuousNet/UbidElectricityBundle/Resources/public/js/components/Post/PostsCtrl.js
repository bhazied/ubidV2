...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $postTypesDataFactory, $usersDataFactory, $postCategoriesDataFactory, $postsDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            ...
            { field: 'average_ratings', title: $filter('translate')('content.list.fields.AVERAGERATINGS'), sortable: 'post.averageRatings', filter: { 'post.averageRatings': 'number' }, show: $scope.getParamValue('average_ratings_show_filed', true), displayInList: true, getValue: $scope.textValue },
            ...
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'post.createdAt', filter: { 'post.createdAt': 'text' }, show: $scope.getParamValue('created_at_show_filed', true), displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'end_publishing', title: $filter('translate')('content.list.fields.ENDPUBLISHING'), sortable: 'post.endPublishing', filter: { 'post.endPublishing': 'text' }, show: $scope.getParamValue('end_publishing_show_filed', true), displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            ...
            { field: 'modified_at', title: $filter('translate')('content.list.fields.MODIFIEDAT'), sortable: 'post.modifiedAt', filter: { 'post.modifiedAt': 'text' }, show: $scope.getParamValue('modified_at_show_filed', false), displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            ...
            { field: 'title', title: $filter('translate')('content.list.fields.TITLE'), sortable: 'post.title', filter: { 'post.title': 'text' }, show: $scope.getParamValue('title_show_filed', false), displayInList: true, getValue: $scope.textValue },
