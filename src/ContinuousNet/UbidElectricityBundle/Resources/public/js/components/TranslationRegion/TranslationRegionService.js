...
/**
 * Translation Regions Data Factory
 */
app.factory('$translationRegionsDataFactory', ['$resource', '$rootScope', '$localStorage', 
function($resource, $rootScope, $localStorage) {

   return $resource('/:locale' + $rootScope.app.apiURL + '/:controller', {locale: $localStorage.language, controller: 'translationregions', id: '@id'}, {
