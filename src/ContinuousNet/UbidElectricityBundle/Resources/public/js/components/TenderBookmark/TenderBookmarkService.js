...
/**
 * Tender Bookmarks Data Factory
 */
app.factory('$tenderBookmarksDataFactory', ['$resource', '$rootScope', '$localStorage', 
function($resource, $rootScope, $localStorage) {

   return $resource('/:locale' + $rootScope.app.apiURL + ':controller', {locale: $localStorage.language, controller: 'tenderbookmarks', id: '@id'}, {
