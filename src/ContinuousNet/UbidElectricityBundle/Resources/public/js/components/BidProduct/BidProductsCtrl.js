...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $tenderProductsDataFactory, $bidsDataFactory, $supplierProductsDataFactory, $usersDataFactory, $bidProductsDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            ...
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'bidProduct.createdAt', filter: { 'bidProduct.createdAt': 'number' }, show: $scope.getParamValue('created_at_show_filed', true), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            ...
            { field: 'modified_at', title: $filter('translate')('content.list.fields.MODIFIEDAT'), sortable: 'bidProduct.modifiedAt', filter: { 'bidProduct.modifiedAt': 'number' }, show: $scope.getParamValue('modified_at_show_filed', true), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            ...
            { field: 'ordering', title: $filter('translate')('content.list.fields.ORDERING'), sortable: 'bidProduct.ordering', filter: { 'bidProduct.ordering': 'number' }, show: $scope.getParamValue('ordering_show_filed', true), getValue: $scope.textValue },
            { field: 'bid', 'class': 'has_one', title: $filter('translate')('content.list.fields.BID'), sortable: 'bid.title', filter: { 'bidProduct.bid': 'select' }, getValue: $scope.linkValue, filterData: $scope.getBids(), show: $scope.getParamValue('bid_id_show_filed', false), displayField: 'title', state: 'app.marketplace.bidsdetails' },
            ...
            { field: 'supplier_product', 'class': 'has_one', title: $filter('translate')('content.list.fields.SUPPLIERPRODUCT'), sortable: 'supplier_product.name', filter: { 'bidProduct.supplierProduct': 'select' }, getValue: $scope.linkValue, filterData: $scope.getSupplierProducts(), show: $scope.getParamValue('supplier_product_id_show_filed', false), displayField: 'name', state: 'app.marketplace.supplierproductsdetails' },
            { field: 'tender_product', 'class': 'has_one', title: $filter('translate')('content.list.fields.TENDERPRODUCT'), sortable: 'tender_product.title', filter: { 'bidProduct.tenderProduct': 'select' }, getValue: $scope.linkValue, filterData: $scope.getTenderProducts(), show: $scope.getParamValue('tender_product_id_show_filed', false), displayField: 'title', state: 'app.marketplace.tenderproductsdetails' },
