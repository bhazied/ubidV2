...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $menusDataFactory, $usersDataFactory, $menuLinksDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            ...
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'menuLink.createdAt', filter: { 'menuLink.createdAt': 'number' }, show: $scope.getParamValue('created_at_show_filed', true), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'modified_at', title: $filter('translate')('content.list.fields.MODIFIEDAT'), sortable: 'menuLink.modifiedAt', filter: { 'menuLink.modifiedAt': 'number' }, show: $scope.getParamValue('modified_at_show_filed', true), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'action', title: $filter('translate')('content.list.fields.ACTION'), sortable: 'menuLink.action', filter: { 'menuLink.action': 'text' }, show: $scope.getParamValue('action_show_filed', true), getValue: $scope.textValue },
            { field: 'controller', title: $filter('translate')('content.list.fields.CONTROLLER'), sortable: 'menuLink.controller', filter: { 'menuLink.controller': 'text' }, show: $scope.getParamValue('controller_show_filed', true), getValue: $scope.textValue },
            { field: 'foreign_key', title: $filter('translate')('content.list.fields.FOREIGNKEY'), sortable: 'menuLink.foreignKey', filter: { 'menuLink.foreignKey': 'number' }, show: $scope.getParamValue('foreign_key_show_filed', true), getValue: $scope.textValue },
            ...
            { field: 'name', title: $filter('translate')('content.list.fields.NAME'), sortable: 'menuLink.name', filter: { 'menuLink.name': 'text' }, show: $scope.getParamValue('name_show_filed', false), getValue: $scope.textValue },
            ...
            { field: 'menu', 'class': 'has_one', title: $filter('translate')('content.list.fields.MENU'), sortable: 'menu.name', filter: { 'menuLink.menu': 'select' }, getValue: $scope.linkValue, filterData: $scope.getMenus(), show: $scope.getParamValue('menu_id_show_filed', false), displayField: 'name', state: 'app.settings.menusdetails' },
