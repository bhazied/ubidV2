...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $menuLinksDataFactory, $usersDataFactory, $translationMenuLinksDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            ...
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'translationMenuLink.createdAt', filter: { 'translationMenuLink.createdAt': 'number' }, show: $scope.getParamValue('created_at_show_filed', true), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'modified_at', title: $filter('translate')('content.list.fields.MODIFIEDAT'), sortable: 'translationMenuLink.modifiedAt', filter: { 'translationMenuLink.modifiedAt': 'number' }, show: $scope.getParamValue('modified_at_show_filed', true), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            ...
            { field: 'menu_link', 'class': 'has_one', title: $filter('translate')('content.list.fields.MENULINK'), sortable: 'menu_link.name', filter: { 'translationMenuLink.menuLink': 'select' }, getValue: $scope.linkValue, filterData: $scope.getMenuLinks(), show: $scope.getParamValue('menu_link_id_show_filed', false), displayField: 'name', state: 'app.settings.menulinksdetails' },
