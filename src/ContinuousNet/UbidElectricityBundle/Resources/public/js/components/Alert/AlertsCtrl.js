...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $usersDataFactory, $categoriesDataFactory, $countriesDataFactory, $alertsDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            { field: 'categories', 'class': 'has_nany', title: $filter('translate')('content.list.fields.CATEGORIES'), filter: { 'alert.categories': 'checkboxes' }, getValue: $scope.linksValue, filterData: $scope.getCategories(), show: $scope.getParamValue('categories_show_filed', false), displayInList: , display: false, displayField: 'name', state: 'app.lists.categoriesdetails' },
            { field: 'countries', 'class': 'has_nany', title: $filter('translate')('content.list.fields.COUNTRIES'), filter: { 'alert.countries': 'checkboxes' }, getValue: $scope.linksValue, filterData: $scope.getCountries(), show: $scope.getParamValue('countries_show_filed', false), displayInList: , display: false, displayField: 'name', state: 'app.settings.countriesdetails' },
