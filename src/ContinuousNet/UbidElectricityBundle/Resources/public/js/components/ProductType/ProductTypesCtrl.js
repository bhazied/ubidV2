...
app.controller('ProductTypesCtrl', ['$scope', '$rootScope', '$sce', '$timeout', '$filter', 'ngTableParams', '$state', '$q', '$interpolate', '$localStorage', 'toaster', 'SweetAlert', '$usersDataFactory', '$productTypesDataFactory',
function($scope, $rootScope, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $usersDataFactory, $productTypesDataFactory) {
    ...
    $scope.getParamValue = function(param, defaultValue) {
        ...
        if (angular.isDefined($localStorage.productTypesParams[param])) {
...
+'</div>') }
    ...
    $scope.tableParams = new ngTableParams({
        ...
        sorting: $scope.getParamValue('sorting', {'productType.name': 'asc'}),
