...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $usersDataFactory, $menusDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            ...
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'menu.createdAt', filter: { 'menu.createdAt': 'number' }, show: $scope.getParamValue('created_at_show_filed', true), displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'modified_at', title: $filter('translate')('content.list.fields.MODIFIEDAT'), sortable: 'menu.modifiedAt', filter: { 'menu.modifiedAt': 'number' }, show: $scope.getParamValue('modified_at_show_filed', true), displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            ...
            { field: 'after_txt', title: $filter('translate')('content.list.fields.AFTERTXT'), sortable: 'menu.afterTxt', filter: { 'menu.afterTxt': 'text' }, show: $scope.getParamValue('after_txt_show_filed', true), displayInList: true, getValue: $scope.textValue },
            { field: 'before_txt', title: $filter('translate')('content.list.fields.BEFORETXT'), sortable: 'menu.beforeTxt', filter: { 'menu.beforeTxt': 'text' }, show: $scope.getParamValue('before_txt_show_filed', true), displayInList: true, getValue: $scope.textValue },
            { field: 'columns_number', title: $filter('translate')('content.list.fields.COLUMNSNUMBER'), sortable: 'menu.columnsNumber', filter: { 'menu.columnsNumber': 'number' }, show: $scope.getParamValue('columns_number_show_filed', true), displayInList: true, getValue: $scope.textValue },
            ...
            { field: 'item_css', title: $filter('translate')('content.list.fields.ITEMCSS'), sortable: 'menu.itemCss', filter: { 'menu.itemCss': 'text' }, show: $scope.getParamValue('item_css_show_filed', false), displayInList: true, getValue: $scope.textValue },
            ...
            { field: 'menu_css', title: $filter('translate')('content.list.fields.MENUCSS'), sortable: 'menu.menuCss', filter: { 'menu.menuCss': 'text' }, show: $scope.getParamValue('menu_css_show_filed', false), displayInList: true, getValue: $scope.textValue },
            { field: 'mode', 'class': 'enum', title: $filter('translate')('content.list.fields.MODE'), sortable: 'menu.mode', filter: { 'menu.mode': 'select' }, show: $scope.getParamValue('mode_show_filed', false), displayInList: true, getValue: $scope.interpolatedValue, filterData : $scope.modesOptions, interpolateExpr: $interpolate('<span class="menuMode" my-enum="[[ row.mode ]]" my-enum-list=\'[[ modes ]]\'></span>') },
            { field: 'name', title: $filter('translate')('content.list.fields.NAME'), sortable: 'menu.name', filter: { 'menu.name': 'text' }, show: $scope.getParamValue('name_show_filed', false), displayInList: true, getValue: $scope.textValue },
