...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $usersDataFactory, $menusDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            { field: 'id', title: $filter('translate')('content.list.fields.ID'), sortable: 'menu.id', filter: { 'menu.id': 'number' }, show: $scope.getParamValue('id_show_filed', true), displayInList: true, getValue: $scope.textValue },
            { field: 'name', title: $filter('translate')('content.list.fields.NAME'), sortable: 'menu.name', filter: { 'menu.name': 'text' }, show: $scope.getParamValue('name_show_filed', true), displayInList: true, getValue: $scope.textValue },
            { field: 'slug', title: $filter('translate')('content.list.fields.SLUG'), sortable: 'menu.slug', filter: { 'menu.slug': 'text' }, show: $scope.getParamValue('slug_show_filed', false), displayInList: true, getValue: $scope.textValue },
            { field: 'mode', 'class': 'enum', title: $filter('translate')('content.list.fields.MODE'), sortable: 'menu.mode', filter: { 'menu.mode': 'select' }, show: $scope.getParamValue('mode_show_filed', true), displayInList: true, getValue: $scope.interpolatedValue, filterData : $scope.modesOptions, interpolateExpr: $interpolate('<span class="menuMode" my-enum="[[ row.mode ]]" my-enum-list=\'[[ modes ]]\'></span>') },
            { field: 'menu_css', title: $filter('translate')('content.list.fields.MENUCSS'), sortable: 'menu.menuCss', filter: { 'menu.menuCss': 'text' }, show: $scope.getParamValue('menu_css_show_filed', true), displayInList: true, getValue: $scope.textValue },
            { field: 'item_css', title: $filter('translate')('content.list.fields.ITEMCSS'), sortable: 'menu.itemCss', filter: { 'menu.itemCss': 'text' }, show: $scope.getParamValue('item_css_show_filed', true), displayInList: true, getValue: $scope.textValue },
            { field: 'active_css', title: $filter('translate')('content.list.fields.ACTIVECSS'), sortable: 'menu.activeCss', filter: { 'menu.activeCss': 'text' }, show: $scope.getParamValue('active_css_show_filed', true), displayInList: true, getValue: $scope.textValue },
            { field: 'not_active_css', title: $filter('translate')('content.list.fields.NOTACTIVECSS'), sortable: 'menu.notActiveCss', filter: { 'menu.notActiveCss': 'text' }, show: $scope.getParamValue('not_active_css_show_filed', false), displayInList: true, getValue: $scope.textValue },
            { field: 'first_css', title: $filter('translate')('content.list.fields.FIRSTCSS'), sortable: 'menu.firstCss', filter: { 'menu.firstCss': 'text' }, show: $scope.getParamValue('first_css_show_filed', false), displayInList: true, getValue: $scope.textValue },
            { field: 'last_css', title: $filter('translate')('content.list.fields.LASTCSS'), sortable: 'menu.lastCss', filter: { 'menu.lastCss': 'text' }, show: $scope.getParamValue('last_css_show_filed', false), displayInList: true, getValue: $scope.textValue },
            { field: 'before_txt', title: $filter('translate')('content.list.fields.BEFORETXT'), sortable: 'menu.beforeTxt', filter: { 'menu.beforeTxt': 'text' }, show: $scope.getParamValue('before_txt_show_filed', false), displayInList: true, getValue: $scope.textValue },
            { field: 'after_txt', title: $filter('translate')('content.list.fields.AFTERTXT'), sortable: 'menu.afterTxt', filter: { 'menu.afterTxt': 'text' }, show: $scope.getParamValue('after_txt_show_filed', false), displayInList: true, getValue: $scope.textValue },
            { field: 'separator', title: $filter('translate')('content.list.fields.SEPARATOR'), sortable: 'menu.separator', filter: { 'menu.separator': 'text' }, show: $scope.getParamValue('separator_show_filed', false), displayInList: true, getValue: $scope.textValue },
            { field: 'columns_number', title: $filter('translate')('content.list.fields.COLUMNSNUMBER'), sortable: 'menu.columnsNumber', filter: { 'menu.columnsNumber': 'number' }, show: $scope.getParamValue('columns_number_show_filed', false), displayInList: true, getValue: $scope.textValue },
            { field: 'display_mode', 'class': 'enum', title: $filter('translate')('content.list.fields.DISPLAYMODE'), sortable: 'menu.displayMode', filter: { 'menu.displayMode': 'select' }, show: $scope.getParamValue('display_mode_show_filed', false), displayInList: true, getValue: $scope.interpolatedValue, filterData : $scope.displayModesOptions, interpolateExpr: $interpolate('<span class="menuDisplayMode" my-enum="[[ row.display_mode ]]" my-enum-list=\'[[ displayModes ]]\'></span>') },
            { field: 'text_position', 'class': 'enum', title: $filter('translate')('content.list.fields.TEXTPOSITION'), sortable: 'menu.textPosition', filter: { 'menu.textPosition': 'select' }, show: $scope.getParamValue('text_position_show_filed', false), displayInList: true, getValue: $scope.interpolatedValue, filterData : $scope.textPositionsOptions, interpolateExpr: $interpolate('<span class="menuTextPosition" my-enum="[[ row.text_position ]]" my-enum-list=\'[[ textPositions ]]\'></span>') },
            ...
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'menu.createdAt', filter: { 'menu.createdAt': 'number' }, show: $scope.getParamValue('created_at_show_filed', false), displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            ...
            { field: 'modified_at', title: $filter('translate')('content.list.fields.MODIFIEDAT'), sortable: 'menu.modifiedAt', filter: { 'menu.modifiedAt': 'number' }, show: $scope.getParamValue('modified_at_show_filed', false), displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'modifier_user', 'class': 'has_one', title: $filter('translate')('content.list.fields.MODIFIERUSER'), sortable: 'modifier_user.username', filter: { 'menu.modifierUser': 'select' }, getValue: $scope.linkValue, filterData: $scope.getUsers(), show: $scope.getParamValue('modifier_user_show_filed', false), displayInList: true, displayField: 'username', state: 'app.access.usersdetails' },
