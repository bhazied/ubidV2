...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $usersDataFactory, $menusDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            ...
            { field: 'before_txt', title: $filter('translate')('content.list.fields.BEFORETXT'), sortable: 'menu.beforeTxt', filter: { 'menu.beforeTxt': 'text' }, show: $scope.getParamValue('before_txt_show_filed', false), getValue: $scope.textValue },
