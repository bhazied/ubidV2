...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $usersDataFactory, $logsDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            { field: 'id', title: $filter('translate')('content.list.fields.ID'), sortable: 'log.id', filter: { 'log.id': 'number' }, displayInList: true, getValue: $scope.textValue },
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'log.createdAt', filter: { 'log.createdAt': 'number' }, displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'action', title: $filter('translate')('content.list.fields.ACTION'), sortable: 'log.action', filter: { 'log.action': 'text' }, displayInList: true, getValue: $scope.textValue },
            { field: 'entity', title: $filter('translate')('content.list.fields.ENTITY'), sortable: 'log.entity', filter: { 'log.entity': 'text' }, displayInList: true, getValue: $scope.textValue },
            { field: 'foreign_key', title: $filter('translate')('content.list.fields.FOREIGNKEY'), sortable: 'log.foreignKey', filter: { 'log.foreignKey': 'number' }, displayInList: true, getValue: $scope.textValue },
            { field: 'ip_address', title: $filter('translate')('content.list.fields.IPADDRESS'), sortable: 'log.ipAddress', filter: { 'log.ipAddress': 'text' }, displayInList: true, getValue: $scope.textValue },
            { field: 'user_agent', title: $filter('translate')('content.list.fields.USERAGENT'), sortable: 'log.userAgent', filter: { 'log.userAgent': 'text' }, displayInList: true, getValue: $scope.textValue },
            { field: 'creator_user', 'class': 'has_one', title: $filter('translate')('content.list.fields.CREATORUSER'), sortable: 'creator_user.username', filter: { 'log.creatorUser': 'select' }, getValue: $scope.linkValue, filterData: $scope.getUsers(), displayInList: true, displayField: 'username', state: 'app.access.usersdetails' },
