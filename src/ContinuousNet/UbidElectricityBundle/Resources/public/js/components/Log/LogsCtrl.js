...
app.controller('LogsCtrl', ['$scope', '$rootScope', '$sce', '$timeout', '$filter', 'ngTableParams', '$state', '$q', '$interpolate', '$localStorage', 'toaster', 'SweetAlert', '$usersDataFactory', '$logsDataFactory',
function($scope, $rootScope, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $usersDataFactory, $logsDataFactory) {
...
+'</div>') }
    ...
    $scope.tableParams = new ngTableParams({
        ...
        sorting: $scope.getParamValue('sorting', {'log.id': 'asc'}),
