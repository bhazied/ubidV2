...
/**
 * Translation Sectors Data Factory
 */
app.factory('$translationSectorsDataFactory', ['$resource', '$rootScope', '$localStorage', 
function($resource, $rootScope, $localStorage) {

   return $resource('/:locale' + $rootScope.app.apiURL + '/:controller', {locale: $localStorage.language, controller: 'translationsectors', id: '@id'}, {
