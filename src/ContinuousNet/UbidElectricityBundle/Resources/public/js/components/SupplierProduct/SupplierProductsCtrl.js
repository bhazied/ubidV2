...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $suppliersDataFactory, $categoriesDataFactory, $usersDataFactory, $supplierProductsDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            ...
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'supplierProduct.createdAt', filter: { 'supplierProduct.createdAt': 'number' }, show: $scope.getParamValue('created_at_show_filed', true), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'modified_at', title: $filter('translate')('content.list.fields.MODIFIEDAT'), sortable: 'supplierProduct.modifiedAt', filter: { 'supplierProduct.modifiedAt': 'number' }, show: $scope.getParamValue('modified_at_show_filed', true), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'unit_cost', title: $filter('translate')('content.list.fields.UNITCOST'), sortable: 'supplierProduct.unitCost', filter: { 'supplierProduct.unitCost': 'number' }, show: $scope.getParamValue('unit_cost_show_filed', true), getValue: $scope.textValue },
            ...
            { field: 'description', title: $filter('translate')('content.list.fields.DESCRIPTION'), sortable: 'supplierProduct.description', filter: { 'supplierProduct.description': 'text' }, show: $scope.getParamValue('description_show_filed', true), getValue: $scope.textValue },
            { field: 'is_public', title: $filter('translate')('content.list.fields.ISPUBLIC'), sortable: 'supplierProduct.isPublic', filter: { 'supplierProduct.isPublic': 'select' }, show: $scope.getParamValue('is_public_show_filed', true), getValue: $scope.interpolatedValue, filterData : $scope.booleanOptions, interpolateExpr: $interpolate('<span my-boolean="[[ row.is_public ]]"></span>') },
            { field: 'model', title: $filter('translate')('content.list.fields.MODEL'), sortable: 'supplierProduct.model', filter: { 'supplierProduct.model': 'text' }, show: $scope.getParamValue('model_show_filed', false), getValue: $scope.textValue },
            { field: 'name', title: $filter('translate')('content.list.fields.NAME'), sortable: 'supplierProduct.name', filter: { 'supplierProduct.name': 'text' }, show: $scope.getParamValue('name_show_filed', false), getValue: $scope.textValue },
            ...
            { field: 'status', 'class': 'enum', title: $filter('translate')('content.list.fields.STATUS'), sortable: 'supplierProduct.status', filter: { 'supplierProduct.status': 'select' }, show: $scope.getParamValue('status_show_filed', false), getValue: $scope.interpolatedValue, filterData : $scope.statusesOptions, interpolateExpr: $interpolate('<span class="supplierProductStatus" my-enum="[[ row.status ]]" my-enum-list=\'[[ statuses ]]\'></span>') },
            { field: 'category', 'class': 'has_one', title: $filter('translate')('content.list.fields.CATEGORY'), sortable: 'category.name', filter: { 'supplierProduct.category': 'select' }, getValue: $scope.linkValue, filterData: $scope.getCategories(), show: $scope.getParamValue('category_id_show_filed', false), displayField: 'name', state: 'app.lists.categoriesdetails' },
