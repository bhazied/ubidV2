 ...
 */
app.factory('$impressionsDataFactory', ['$resource', '$rootScope', '$localStorage', 
function($resource, $rootScope, $localStorage) {

   return $resource('/:locale' + $rootScope.app.apiURL + '/:controller', {locale: $localStorage.language, controller: 'impressions', id: '@id'}, {
