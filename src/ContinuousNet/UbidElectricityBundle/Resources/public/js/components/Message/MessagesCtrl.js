...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $usersDataFactory, $buyersDataFactory, $suppliersDataFactory, $messagesDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            ...
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'message.createdAt', filter: { 'message.createdAt': 'text' }, show: $scope.getParamValue('created_at_show_filed', true), displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'modified_at', title: $filter('translate')('content.list.fields.MODIFIEDAT'), sortable: 'message.modifiedAt', filter: { 'message.modifiedAt': 'text' }, show: $scope.getParamValue('modified_at_show_filed', true), displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'reading_time', title: $filter('translate')('content.list.fields.READINGTIME'), sortable: 'message.readingTime', filter: { 'message.readingTime': 'text' }, show: $scope.getParamValue('reading_time_show_filed', true), displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'sending_time', title: $filter('translate')('content.list.fields.SENDINGTIME'), sortable: 'message.sendingTime', filter: { 'message.sendingTime': 'text' }, show: $scope.getParamValue('sending_time_show_filed', true), displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'is_read', title: $filter('translate')('content.list.fields.ISREAD'), sortable: 'message.isRead', filter: { 'message.isRead': 'select' }, show: $scope.getParamValue('is_read_show_filed', true), displayInList: true, getValue: $scope.interpolatedValue, filterData : $scope.booleanOptions, interpolateExpr: $interpolate('<span my-boolean="[[ row.is_read ]]"></span>') },
            ...
            { field: 'from_buyer', 'class': 'has_one', title: $filter('translate')('content.list.fields.FROMBUYER'), sortable: 'from_buyer.name', filter: { 'message.fromBuyer': 'select' }, getValue: $scope.linkValue, filterData: $scope.getBuyers(), show: $scope.getParamValue('from_buyer_id_show_filed', false), displayInList: true, displayField: 'name', state: 'app.marketplace.buyersdetails' },
            ...
            { field: 'from_user', 'class': 'has_one', title: $filter('translate')('content.list.fields.FROMUSER'), sortable: 'from_user.username', filter: { 'message.fromUser': 'select' }, getValue: $scope.linkValue, filterData: $scope.getUsers(), show: $scope.getParamValue('from_user_id_show_filed', false), displayInList: true, displayField: 'username', state: 'app.access.usersdetails' },
            ...
            { field: 'to_buyer', 'class': 'has_one', title: $filter('translate')('content.list.fields.TOBUYER'), sortable: 'to_buyer.name', filter: { 'message.toBuyer': 'select' }, getValue: $scope.linkValue, filterData: $scope.getBuyers(), show: $scope.getParamValue('to_buyer_id_show_filed', false), displayInList: true, displayField: 'name', state: 'app.marketplace.buyersdetails' },
            { field: 'to_supplier', 'class': 'has_one', title: $filter('translate')('content.list.fields.TOSUPPLIER'), sortable: 'to_supplier.name', filter: { 'message.toSupplier': 'select' }, getValue: $scope.linkValue, filterData: $scope.getSuppliers(), show: $scope.getParamValue('to_supplier_id_show_filed', false), displayInList: true, displayField: 'name', state: 'app.marketplace.suppliersdetails' },
            { field: 'to_user', 'class': 'has_one', title: $filter('translate')('content.list.fields.TOUSER'), sortable: 'to_user.username', filter: { 'message.toUser': 'select' }, getValue: $scope.linkValue, filterData: $scope.getUsers(), show: $scope.getParamValue('to_user_id_show_filed', false), displayInList: true, displayField: 'username', state: 'app.access.usersdetails' },
