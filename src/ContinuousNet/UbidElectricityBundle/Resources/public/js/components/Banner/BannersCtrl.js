...
function($scope, $rootScope, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $bannerTypesDataFactory, $usersDataFactory, $bannerPositionsDataFactory, $bannersDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            ...
            { field: 'banner_type', title: $filter('translate')('content.list.fields.BANNERTYPE'), sortable: 'banner_type.name', filter: { 'banner.bannerType': 'select' }, getValue: $scope.linkValue, filterData: $scope.getBannerTypes(), show: $scope.getParamValue('banner_type_id_show_filed', true), displayField: 'name', state: 'app.adserving.bannertypesdetails' },
            { field: 'name', title: $filter('translate')('content.list.fields.NAME'), sortable: 'banner.name', filter: { 'banner.name': 'text' }, show: $scope.getParamValue('name_show_filed', true), getValue: $scope.textValue },
            ...
            { field: 'closable', title: $filter('translate')('content.list.fields.CLOSABLE'), sortable: 'banner.closable', filter: { 'banner.closable': 'select' }, show: $scope.getParamValue('closable_show_filed', true), getValue: $scope.interpolatedValue, filterData : $scope.booleanOptions, interpolateExpr: $interpolate('<span my-boolean="[[ row.closable ]]"></span>') },
            { field: 'count_down', title: $filter('translate')('content.list.fields.COUNTDOWN'), sortable: 'banner.countDown', filter: { 'banner.countDown': 'number' }, show: $scope.getParamValue('count_down_show_filed', true), getValue: $scope.textValue },
            { field: 'iphone_action', title: $filter('translate')('content.list.fields.IPHONEACTION'), sortable: 'banner.iphoneAction', filter: { 'banner.iphoneAction': 'text' }, show: $scope.getParamValue('iphone_action_show_filed', true), getValue: $scope.textValue },
            ...
            { field: 'gender', title: $filter('translate')('content.list.fields.GENDER'), sortable: 'banner.gender', filter: { 'banner.gender': 'select' }, show: $scope.getParamValue('gender_show_filed', false), getValue: $scope.interpolatedValue, filterData : $scope.gendersOptions, interpolateExpr: $interpolate('<span my-enum="[[ row.gender ]]" my-enum-list=\'[[ genders ]]\'></span>') },
            ...
            { field: 'map_latitude', title: $filter('translate')('content.list.fields.MAPLATITUDE'), sortable: 'banner.mapLatitude', filter: { 'banner.mapLatitude': 'number' }, show: $scope.getParamValue('map_latitude_show_filed', false), getValue: $scope.textValue },
            { field: 'map_longitude', title: $filter('translate')('content.list.fields.MAPLONGITUDE'), sortable: 'banner.mapLongitude', filter: { 'banner.mapLongitude': 'number' }, show: $scope.getParamValue('map_longitude_show_filed', false), getValue: $scope.textValue },
            ...
            { field: 'start_publishing', title: $filter('translate')('content.list.fields.STARTPUBLISHING'), sortable: 'banner.startPublishing', filter: { 'banner.startPublishing': 'text' }, show: $scope.getParamValue('start_publishing_show_filed', false), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'end_publishing', title: $filter('translate')('content.list.fields.ENDPUBLISHING'), sortable: 'banner.endPublishing', filter: { 'banner.endPublishing': 'text' }, show: $scope.getParamValue('end_publishing_show_filed', false), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
