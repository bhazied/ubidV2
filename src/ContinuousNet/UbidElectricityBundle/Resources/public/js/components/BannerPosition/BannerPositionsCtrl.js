...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $usersDataFactory, $bannerPositionsDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            ...
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'bannerPosition.createdAt', filter: { 'bannerPosition.createdAt': 'number' }, show: $scope.getParamValue('created_at_show_filed', true), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'modified_at', title: $filter('translate')('content.list.fields.MODIFIEDAT'), sortable: 'bannerPosition.modifiedAt', filter: { 'bannerPosition.modifiedAt': 'number' }, show: $scope.getParamValue('modified_at_show_filed', true), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            ...
            { field: 'items_number', title: $filter('translate')('content.list.fields.ITEMSNUMBER'), sortable: 'bannerPosition.itemsNumber', filter: { 'bannerPosition.itemsNumber': 'number' }, show: $scope.getParamValue('items_number_show_filed', false), getValue: $scope.textValue },
            { field: 'name', title: $filter('translate')('content.list.fields.NAME'), sortable: 'bannerPosition.name', filter: { 'bannerPosition.name': 'text' }, show: $scope.getParamValue('name_show_filed', false), getValue: $scope.textValue },
