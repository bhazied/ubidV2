...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $usersDataFactory, $bannerPositionsDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            { field: 'id', title: $filter('translate')('content.list.fields.ID'), sortable: 'bannerPosition.id', filter: { 'bannerPosition.id': 'number' }, show: $scope.getParamValue('id_show_filed', true), displayInList: true, getValue: $scope.textValue },
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'bannerPosition.createdAt', filter: { 'bannerPosition.createdAt': 'number' }, show: $scope.getParamValue('created_at_show_filed', true), displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'modified_at', title: $filter('translate')('content.list.fields.MODIFIEDAT'), sortable: 'bannerPosition.modifiedAt', filter: { 'bannerPosition.modifiedAt': 'number' }, show: $scope.getParamValue('modified_at_show_filed', true), displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'display_one_time', title: $filter('translate')('content.list.fields.DISPLAYONETIME'), sortable: 'bannerPosition.displayOneTime', filter: { 'bannerPosition.displayOneTime': 'select' }, show: $scope.getParamValue('display_one_time_show_filed', true), displayInList: true, getValue: $scope.interpolatedValue, filterData : $scope.booleanOptions, interpolateExpr: $interpolate('<span my-boolean="[[ row.display_one_time ]]"></span>') },
            { field: 'display_time', title: $filter('translate')('content.list.fields.DISPLAYTIME'), sortable: 'bannerPosition.displayTime', filter: { 'bannerPosition.displayTime': 'number' }, show: $scope.getParamValue('display_time_show_filed', true), displayInList: true, getValue: $scope.textValue },
            ...
            { field: 'items_number', title: $filter('translate')('content.list.fields.ITEMSNUMBER'), sortable: 'bannerPosition.itemsNumber', filter: { 'bannerPosition.itemsNumber': 'number' }, show: $scope.getParamValue('items_number_show_filed', false), displayInList: true, getValue: $scope.textValue },
            { field: 'name', title: $filter('translate')('content.list.fields.NAME'), sortable: 'bannerPosition.name', filter: { 'bannerPosition.name': 'text' }, show: $scope.getParamValue('name_show_filed', false), displayInList: true, getValue: $scope.textValue },
            { field: 'slug', title: $filter('translate')('content.list.fields.SLUG'), sortable: 'bannerPosition.slug', filter: { 'bannerPosition.slug': 'text' }, show: $scope.getParamValue('slug_show_filed', false), displayInList: true, getValue: $scope.textValue },
            { field: 'creator_user', 'class': 'has_one', title: $filter('translate')('content.list.fields.CREATORUSER'), sortable: 'creator_user.username', filter: { 'bannerPosition.creatorUser': 'select' }, getValue: $scope.linkValue, filterData: $scope.getUsers(), show: $scope.getParamValue('creator_user_id_show_filed', false), displayInList: true, displayField: 'username', state: 'app.access.usersdetails' },
            { field: 'modifier_user', 'class': 'has_one', title: $filter('translate')('content.list.fields.MODIFIERUSER'), sortable: 'modifier_user.username', filter: { 'bannerPosition.modifierUser': 'select' }, getValue: $scope.linkValue, filterData: $scope.getUsers(), show: $scope.getParamValue('modifier_user_id_show_filed', false), displayInList: true, displayField: 'username', state: 'app.access.usersdetails' },
