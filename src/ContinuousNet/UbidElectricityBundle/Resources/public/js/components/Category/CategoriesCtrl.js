...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $productTypesDataFactory, $usersDataFactory, $categoriesDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            ...
            { field: 'tenders_description', title: $filter('translate')('content.list.fields.TENDERSDESCRIPTION'), sortable: 'category.tendersDescription', filter: { 'category.tendersDescription': 'text' }, show: ($scope.getParamValue('tenders_description_show_filed', false) && true), displayInList: true, getValue: $scope.textValue },
            ...
            { field: 'consultations_description', title: $filter('translate')('content.list.fields.CONSULTATIONSDESCRIPTION'), sortable: 'category.consultationsDescription', filter: { 'category.consultationsDescription': 'text' }, show: ($scope.getParamValue('consultations_description_show_filed', false) && true), displayInList: true, getValue: $scope.textValue },
            ...
            { field: 'buyers_description', title: $filter('translate')('content.list.fields.BUYERSDESCRIPTION'), sortable: 'category.buyersDescription', filter: { 'category.buyersDescription': 'text' }, show: ($scope.getParamValue('buyers_description_show_filed', false) && true), displayInList: true, getValue: $scope.textValue },
            ...
            { field: 'suppliers_description', title: $filter('translate')('content.list.fields.SUPPLIERSDESCRIPTION'), sortable: 'category.suppliersDescription', filter: { 'category.suppliersDescription': 'text' }, show: ($scope.getParamValue('suppliers_description_show_filed', false) && true), displayInList: true, getValue: $scope.textValue },
