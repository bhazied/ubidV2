...
function($scope, $rootScope, $stateParams, $location, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $visitsDataFactory, $usersDataFactory, $hitsDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            { field: 'id', title: $filter('translate')('content.list.fields.ID'), sortable: 'hit.id', filter: { 'hit.id': 'number' }, displayInList: true, getValue: $scope.textValue },
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'hit.createdAt', filter: { 'hit.createdAt': 'number' }, displayInList: true, getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            { field: 'entity', title: $filter('translate')('content.list.fields.ENTITY'), sortable: 'hit.entity', filter: { 'hit.entity': 'text' }, displayInList: true, getValue: $scope.textValue },
            { field: 'foreign_key', title: $filter('translate')('content.list.fields.FOREIGNKEY'), sortable: 'hit.foreignKey', filter: { 'hit.foreignKey': 'number' }, displayInList: true, getValue: $scope.textValue },
            { field: 'url', title: $filter('translate')('content.list.fields.URL'), sortable: 'hit.url', filter: { 'hit.url': 'text' }, displayInList: true, getValue: $scope.textValue },
            { field: 'creator_user', 'class': 'has_one', title: $filter('translate')('content.list.fields.CREATORUSER'), sortable: 'creator_user.username', filter: { 'hit.creatorUser': 'select' }, getValue: $scope.linkValue, filterData: $scope.getUsers(), displayInList: true, displayField: 'username', state: 'app.access.usersdetails' },
            { field: 'visit', 'class': 'has_one', title: $filter('translate')('content.list.fields.VISIT'), sortable: 'visit.ip', filter: { 'hit.visit': 'select' }, getValue: $scope.linkValue, filterData: $scope.getVisits(), displayInList: true, displayField: 'ip', state: 'app.statistics.visitsdetails' },
