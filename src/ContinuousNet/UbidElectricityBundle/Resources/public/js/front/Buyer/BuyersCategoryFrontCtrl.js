...
/**
 * Controller for Category Buyers
 */

app.controller('BuyersCategoryFrontCtrl', ['$scope', '$controller', '$rootScope', '$state', '$stateParams', '$sce', '$timeout', '$filter', '$q', '$interpolate', '$localStorage', '$buyersFrontDataFactory',
    function($scope, $controller, $rootScope, $state, $stateParams, $sce, $timeout, $filter, $q, $interpolate, $localStorage, $buyersFrontDataFactory) {
        ...
        $scope.getCategory = function() {
            if (angular.isDefined($stateParams.slug)) {
                $buyersFrontDataFactory.category({
                    ...
                    $scope.total = data.buyers.length;
