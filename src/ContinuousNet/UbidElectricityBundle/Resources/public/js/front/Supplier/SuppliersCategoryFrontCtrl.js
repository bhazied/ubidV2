...
/**
 * Controller for Category Suppliers
 */

app.controller('SuppliersCategoryFrontCtrl', ['$scope', '$controller', '$rootScope', '$state', '$stateParams', '$sce', '$timeout', '$filter', '$q', '$interpolate', '$localStorage', '$suppliersFrontDataFactory',
    function($scope, $controller, $rootScope, $state, $stateParams, $sce, $timeout, $filter, $q, $interpolate, $localStorage, $suppliersFrontDataFactory) {
        ...
        $scope.getCategory = function() {
            if (angular.isDefined($stateParams.slug)) {
                $suppliersFrontDataFactory.category({
                    ...
                    $scope.total = data.suppliers.length;
