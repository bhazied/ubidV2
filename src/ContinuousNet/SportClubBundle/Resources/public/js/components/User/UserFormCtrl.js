...
app.controller('UserFormCtrl', ['$scope', '$state', '$stateParams', '$sce', '$timeout', '$filter', '$uibModal', '$q', '$interpolate', '$localStorage', 'toaster', 'SweetAlert', 'savable', '$companiesDataFactory', '$countriesDataFactory', '$citiesDataFactory', '$languagesDataFactory', '$groupsDataFactory', '$usersDataFactory',
function($scope, $state, $stateParams, $sce, $timeout, $filter, $uibModal, $q, $interpolate, $localStorage, toaster, SweetAlert, savable, $companiesDataFactory, $countriesDataFactory, $citiesDataFactory, $languagesDataFactory, $groupsDataFactory, $usersDataFactory) {
    ...
    $scope.user_company_readonly = false;
    $scope.user_country_readonly = false;
    $scope.user_city_readonly = false;
    ...
    if (angular.isDefined($stateParams.id)) {
        ...
        if (angular.isDefined($stateParams.user_company) && JSON.parse($stateParams.user_company) != null) {
            $scope.user.company = $stateParams.user_company;
            $scope.user_company_readonly = true;
        }
        ...
        if (angular.isDefined($stateParams.user_city) && JSON.parse($stateParams.user_city) != null) {
            $scope.user.city = $stateParams.user_city;
            $scope.user_city_readonly = true;
        }
