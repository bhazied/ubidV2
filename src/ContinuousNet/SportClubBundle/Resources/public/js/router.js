...
function ($stateProvider) {
    ...
    $stateProvider.state('auth', {
        ...
        url: '/reporting',
        templateUrl: '/bundles/sportclub/js/components/Reporting/reporting.html',
        ...
        resolve: loadSequence('AudiosCtrl', 'audioService', 'audioTypeService', 'priceService', 'sharingService', 'albumService', 'artistService', 'userService', 'audioCategoryService')
        ...
        resolve: loadSequence('AudioFormCtrl', 'audioService', 'audioTypeService', 'priceService', 'sharingService', 'albumService', 'artistService', 'userService', 'audioCategoryService', 'ui.select', 'monospaced.elastic', 'touchspin-plugin', 'checklist-model', 'ckeditor-plugin', 'ckeditor')
    ...
    }).state('app.webradio.artists', {
        url: '/artists',
        templateUrl: '/bundles/sportclub/js/components/Artist/artists.html',
        title: 'content.list.ARTISTS',
        ncyBreadcrumb: {
            label: 'content.list.ARTISTS'
        },
        params: {
            'artistsIsFiltersVisible': null,
            'artistsPage': null,
            'artistsCount': null,
            'artistsSorting': null,
            'artistsFilter': null
        },
        resolve: loadSequence('ArtistsCtrl', 'artistService', 'countryService', 'userService')
    }).state('app.webradio.artistsnew', {
        url: '/artists/new',
        templateUrl: '/bundles/sportclub/js/components/Artist/artist_form.html',
        title: 'content.list.NEWARTIST',
        ncyBreadcrumb: {
            label: 'content.list.NEWARTIST'
        },
        params: {
            'artist_country': null
        },
        resolve: loadSequence('ArtistFormCtrl', 'artistService', 'countryService', 'userService', 'ui.select', 'monospaced.elastic', 'touchspin-plugin', 'checklist-model', 'ckeditor-plugin', 'ckeditor')
    }).state('app.webradio.artistsedit', {
        url: '/artists/edit/:id',
        templateUrl: '/bundles/sportclub/js/components/Artist/artist_form.html',
        title: 'content.list.EDITARTIST',
        ncyBreadcrumb: {
            label: 'content.list.EDITARTIST'
        },
        resolve: loadSequence('ArtistFormCtrl', 'artistService', 'countryService', 'userService', 'ui.select', 'monospaced.elastic', 'touchspin-plugin', 'checklist-model', 'ckeditor-plugin', 'ckeditor')
    }).state('app.webradio.artistsdetails', {
        url: '/artists/details/:id',
        templateUrl: '/bundles/sportclub/js/components/Artist/artist.html',
        ncyBreadcrumb: {
            label: 'content.list.ARTISTDETAILS'
        },
        resolve: loadSequence('ArtistCtrl', 'artistService')
    }).state('app.adserving', {
        url: '/adserving',
        template: '<div ui-view class="fade-in-up"></div>',
        ...
        url: '/faqs',
        templateUrl: '/bundles/sportclub/js/components/Faq/faqs.html',
        ...
        url: '/faqs/new',
        templateUrl: '/bundles/sportclub/js/components/Faq/faq_form.html',
        ...
        url: '/faqs/details/:id',
        templateUrl: '/bundles/sportclub/js/components/Faq/faq.html',
        ncyBreadcrumb: {
        ...
        url: '/faq-categories',
        templateUrl: '/bundles/sportclub/js/components/FaqCategory/faq_categories.html',
        ...
        templateUrl: '/bundles/sportclub/js/components/FaqCategory/faq_category_form.html',
        ...
        templateUrl: '/bundles/sportclub/js/components/FaqCategory/faq_category.html',
        ncyBreadcrumb: {
        ...
        resolve: loadSequence('PushNotificationsCtrl', 'pushNotificationService', 'matchService', 'matchSubstitutionService', 'matchGoalService', 'postService', 'videoService', 'audioService', 'galleryService', 'artistService', 'albumService', 'audioCategoryService', 'userService')
        ...
        params: {
            ...
            'push_notification_artist': null,
            'push_notification_album': null,
            'push_notification_audio_category': null
        },
        resolve: loadSequence('PushNotificationFormCtrl', 'pushNotificationService', 'matchService', 'matchSubstitutionService', 'matchGoalService', 'postService', 'videoService', 'audioService', 'galleryService', 'artistService', 'albumService', 'audioCategoryService', 'userService', 'ui.select', 'monospaced.elastic', 'touchspin-plugin', 'checklist-model', 'ckeditor-plugin', 'ckeditor')
