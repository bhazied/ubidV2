...
class FaqCategoryController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$faqCategories = $em->getRepository('SportClubBundle:FaqCategory')->findAll();

		return $this->render('SportClubBundle:FaqCategory:index.html.twig', array(
	...
	public function newAction(Request $request)
	{
		...
		$form = $this->createForm('ContinuousNet\SportClubBundle\Form\FaqCategoryType', $faqCategory);
		...
		return $this->render('SportClubBundle:FaqCategory:new.html.twig', array(
	...
	public function showAction(FaqCategory $faqCategory)
	{
		...
		return $this->render('SportClubBundle:FaqCategory:show.html.twig', array(
			'faqCategory' => $faqCategory,
	...
	{
		$deleteForm = $this->createDeleteForm($faqCategory);
		$editForm = $this->createForm('ContinuousNet\SportClubBundle\Form\FaqCategoryType', $faqCategory);
		...
		return $this->render('SportClubBundle:FaqCategory:edit.html.twig', array(
			'faqCategory' => $faqCategory,
