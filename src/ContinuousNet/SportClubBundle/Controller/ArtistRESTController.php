 ...
 * @see      ArtistRESTController
 * @since      Class available since Release 1.0
 * @access    public
 * @RouteResource("Artist")
 */
class ArtistRESTController extends BaseRESTController
{
    /**
     * Get a Artist entity
     *
    ...
    {
        try {
            $this->createSubDirectory(new Artist());
            ...
            $qb->from('SportClubBundle:Artist', 'a_');
            $qb->leftJoin('ContinuousNet\SportClubBundle\Entity\Country', 'country', \Doctrine\ORM\Query\Expr\Join::WITH, 'a_.country = country.id');
            ...
            $textFields = array('artist.name', 'artist.nameAr', 'artist.nameFr', 'artist.slug', 'artist.slugAr', 'artist.slugFr', 'artist.startWith', 'artist.startWithAr', 'artist.startWithFr', 'artist.picture');
            foreach ($filters as $field => $value) {
                ...
                $_field = str_replace('artist.', 'a_.', $field);
            ...
            foreach ($order_by as $field => $direction) {
                $field = str_replace('artist.', 'a_.', $field);
    ...
    public function postAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $entity = new Artist();
        $form = $this->createForm(new ArtistType(), $entity, array('method' => $request->getMethod()));
