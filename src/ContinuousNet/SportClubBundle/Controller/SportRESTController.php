 ...
 * @see      SportRESTController
 * @since      Class available since Release 1.0
 * @access    public
 * @RouteResource("Sport")
 */
class SportRESTController extends BaseRESTController
{
    /**
     * Get a Sport entity
     *
     ...
     *
     */
    public function getAction(Sport $entity)
    {
    ...
    {
        try {
            $this->createSubDirectory(new Sport());
            ...
            $qb->from('SportClubBundle:Sport', 's_');
            ...
            $textFields = array('sport.name', 'sport.nameAr', 'sport.nameFr', 'sport.picture');
            ...
            foreach ($filters as $field => $value) {
                ...
                $_field = str_replace('sport.', 's_.', $field);
            ...
            foreach ($order_by as $field => $direction) {
                $field = str_replace('sport.', 's_.', $field);
    ...
    public function postAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $entity = new Sport();
        $form = $this->createForm(new SportType(), $entity, array('method' => $request->getMethod()));
     ...
     * @return Response
     */
    public function putAction(Request $request, Sport $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Sport entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, Sport $entity)
    {
     ...
     * @return Response
     */
    public function deleteAction(Request $request, Sport $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
