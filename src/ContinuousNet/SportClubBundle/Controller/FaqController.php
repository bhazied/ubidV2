...
class FaqController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$faqs = $em->getRepository('SportClubBundle:Faq')->findAll();

		return $this->render('SportClubBundle:Faq:index.html.twig', array(
			'faqs' => $faqs,
		));
	}
	...
	{
		$faq = new Faq();
		$form = $this->createForm('ContinuousNet\SportClubBundle\Form\FaqType', $faq);
		...
		return $this->render('SportClubBundle:Faq:new.html.twig', array(
			'faq' => $faq,
	...
	public function showAction(Faq $faq)
	{
		...
		return $this->render('SportClubBundle:Faq:show.html.twig', array(
			'faq' => $faq,
	...
	{
		$deleteForm = $this->createDeleteForm($faq);
		$editForm = $this->createForm('ContinuousNet\SportClubBundle\Form\FaqType', $faq);
		...
		return $this->render('SportClubBundle:Faq:edit.html.twig', array(
			'faq' => $faq,
