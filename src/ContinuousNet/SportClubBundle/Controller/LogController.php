...
use ContinuousNet\SportClubBundle\Entity\Log;
use ContinuousNet\SportClubBundle\Form\LogType;
...
class LogController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$logs = $em->getRepository('SportClubBundle:Log')->findAll();

		return $this->render('SportClubBundle:Log:index.html.twig', array(
			'logs' => $logs,
		));
	}
	...
	{
		$log = new Log();
		$form = $this->createForm('ContinuousNet\SportClubBundle\Form\LogType', $log);
		...
		return $this->render('SportClubBundle:Log:new.html.twig', array(
			'log' => $log,
	...
	public function showAction(Log $log)
	{
		...
		return $this->render('SportClubBundle:Log:show.html.twig', array(
			'log' => $log,
	...
	{
		$deleteForm = $this->createDeleteForm($log);
		$editForm = $this->createForm('ContinuousNet\SportClubBundle\Form\LogType', $log);
		...
		return $this->render('SportClubBundle:Log:edit.html.twig', array(
			'log' => $log,
