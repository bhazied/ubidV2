...
class CountryRESTController extends BaseRESTController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $qb->from('SportClubBundle:Country', 'c_');
            ...
            $textFields = array('country.name', 'country.nameAr', 'country.nameFr', 'country.picture', 'country.code', 'country.longCode', 'country.prefix');
