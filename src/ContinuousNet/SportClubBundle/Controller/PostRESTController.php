...
class PostRESTController extends BaseRESTController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $qb->from('SportClubBundle:Post', 'p_');
            $qb->leftJoin('ContinuousNet\SportClubBundle\Entity\PostType', 'post_type', \Doctrine\ORM\Query\Expr\Join::WITH, 'p_.postType = post_type.id');
