...
class PushNotificationRESTController extends BaseRESTController
{
    ...
    {
        try {
            $this->createSubDirectory(new PushNotification());
            ...
            $qb->leftJoin('ContinuousNet\SportClubBundle\Entity\Artist', 'artist', \Doctrine\ORM\Query\Expr\Join::WITH, 'pn_.artist = artist.id');
            $qb->leftJoin('ContinuousNet\SportClubBundle\Entity\Album', 'album', \Doctrine\ORM\Query\Expr\Join::WITH, 'pn_.album = album.id');
            $qb->leftJoin('ContinuousNet\SportClubBundle\Entity\AudioCategory', 'audio_category', \Doctrine\ORM\Query\Expr\Join::WITH, 'pn_.audioCategory = audio_category.id');
            ...
            $textFields = array('pushNotification.title', 'pushNotification.titleAr', 'pushNotification.titleFr', 'pushNotification.message', 'pushNotification.messageAr', 'pushNotification.messageFr', 'pushNotification.category');
