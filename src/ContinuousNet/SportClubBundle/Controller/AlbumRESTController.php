 ...
 * @see      AlbumRESTController
 * @since      Class available since Release 1.0
 * @access    public
 * @RouteResource("Album")
 */
class AlbumRESTController extends BaseRESTController
{
    /**
     * Get a Album entity
     *
     ...
     *
     */
    public function getAction(Album $entity)
    {
    ...
    {
        try {
            $this->createSubDirectory(new Album());
            ...
            $qb->from('SportClubBundle:Album', 'a_');
            ...
            $textFields = array('album.name', 'album.nameAr', 'album.nameFr', 'album.slug', 'album.slugAr', 'album.slugFr', 'album.startWith', 'album.startWithAr', 'album.startWithFr', 'album.picture');
            ...
            foreach ($filters as $field => $value) {
                ...
                $_field = str_replace('album.', 'a_.', $field);
            ...
            foreach ($order_by as $field => $direction) {
                $field = str_replace('album.', 'a_.', $field);
    ...
    public function postAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $entity = new Album();
        $form = $this->createForm(new AlbumType(), $entity, array('method' => $request->getMethod()));
     ...
     * @return Response
     */
    public function putAction(Request $request, Album $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Album entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, Album $entity)
    {
        return $this->putAction($request, $entity);
    }

    /**
     * Delete a Album entity.
     *
     * @View(statusCode=204)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function deleteAction(Request $request, Album $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
