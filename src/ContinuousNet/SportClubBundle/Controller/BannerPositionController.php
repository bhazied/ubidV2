...
class BannerPositionController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$bannerPositions = $em->getRepository('SportClubBundle:BannerPosition')->findAll();

		return $this->render('SportClubBundle:BannerPosition:index.html.twig', array(
	...
	public function newAction(Request $request)
	{
		...
		$form = $this->createForm('ContinuousNet\SportClubBundle\Form\BannerPositionType', $bannerPosition);
		...
		return $this->render('SportClubBundle:BannerPosition:new.html.twig', array(
	...
	public function showAction(BannerPosition $bannerPosition)
	{
		...
		return $this->render('SportClubBundle:BannerPosition:show.html.twig', array(
			'bannerPosition' => $bannerPosition,
	...
	{
		$deleteForm = $this->createDeleteForm($bannerPosition);
		$editForm = $this->createForm('ContinuousNet\SportClubBundle\Form\BannerPositionType', $bannerPosition);
		...
		return $this->render('SportClubBundle:BannerPosition:edit.html.twig', array(
			'bannerPosition' => $bannerPosition,
