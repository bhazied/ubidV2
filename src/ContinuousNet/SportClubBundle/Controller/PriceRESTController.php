 ...
 * @see      PriceRESTController
 * @since      Class available since Release 1.0
 * @access    public
 * @RouteResource("Price")
 */
class PriceRESTController extends BaseRESTController
{
    /**
     * Get a Price entity
     *
     ...
     *
     */
    public function getAction(Price $entity)
    {
    ...
    {
        try {
            $this->createSubDirectory(new Price());
            ...
            $qb->from('SportClubBundle:Price', 'p_');
            ...
            $textFields = array('price.name', 'price.nameAr', 'price.nameFr', 'price.currency');
            ...
            foreach ($filters as $field => $value) {
                ...
                $_field = str_replace('price.', 'p_.', $field);
            ...
            foreach ($order_by as $field => $direction) {
                $field = str_replace('price.', 'p_.', $field);
    ...
    public function postAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $entity = new Price();
        $form = $this->createForm(new PriceType(), $entity, array('method' => $request->getMethod()));
     ...
     * @return Response
     */
    public function putAction(Request $request, Price $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Price entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, Price $entity)
    {
        return $this->putAction($request, $entity);
    }

    /**
     * Delete a Price entity.
     *
     * @View(statusCode=204)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function deleteAction(Request $request, Price $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
