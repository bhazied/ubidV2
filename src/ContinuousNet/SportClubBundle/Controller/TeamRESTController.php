...
class TeamRESTController extends BaseRESTController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $textFields = array('team.name', 'team.nameAr', 'team.nameFr', 'team.alias', 'team.picture', 'team.presidentName', 'team.coachName', 'team.address', 'team.zipCode', 'team.phone', 'team.fax', 'team.email', 'team.website', 'team.color', 'team.summary', 'team.eurosport', 'team.lequipe');
