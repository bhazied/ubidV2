 ...
 * @RouteResource("Team")
 */
class TeamRESTController extends BaseRESTController
{
    /**
     * Get a Team entity
     *
    ...
    {
        try {
            $this->createSubDirectory(new Team());
            ...
            $qb->from('SportClubBundle:Team', 't_');
            $qb->leftJoin('ContinuousNet\SportClubBundle\Entity\Country', 'country', \Doctrine\ORM\Query\Expr\Join::WITH, 't_.country = country.id');
            $qb->leftJoin('ContinuousNet\SportClubBundle\Entity\Stadium', 'stadium', \Doctrine\ORM\Query\Expr\Join::WITH, 't_.stadium = stadium.id');
            ...
            $textFields = array('team.name', 'team.nameAr', 'team.nameFr', 'team.alias', 'team.picture', 'team.presidentName', 'team.coachName', 'team.address', 'team.zipCode', 'team.phone', 'team.fax', 'team.email', 'team.website', 'team.fifaRatingMonth', 'team.color', 'team.summary', 'team.eurosport', 'team.lequipe');
            ...
            foreach ($filters as $field => $value) {
                ...
                $_field = str_replace('team.', 't_.', $field);
            ...
            foreach ($order_by as $field => $direction) {
                $field = str_replace('team.', 't_.', $field);
