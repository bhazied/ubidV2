...
use ContinuousNet\SportClubBundle\Entity\Language;
use ContinuousNet\SportClubBundle\Form\LanguageType;
...
class LanguageController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$languages = $em->getRepository('SportClubBundle:Language')->findAll();

		return $this->render('SportClubBundle:Language:index.html.twig', array(
			'languages' => $languages,
		));
	}
	...
	public function newAction(Request $request)
	{
		...
		$form = $this->createForm('ContinuousNet\SportClubBundle\Form\LanguageType', $language);
		...
		return $this->render('SportClubBundle:Language:new.html.twig', array(
			'language' => $language,
	...
	public function showAction(Language $language)
	{
		...
		return $this->render('SportClubBundle:Language:show.html.twig', array(
			'language' => $language,
	...
	{
		$deleteForm = $this->createDeleteForm($language);
		$editForm = $this->createForm('ContinuousNet\SportClubBundle\Form\LanguageType', $language);
		...
		return $this->render('SportClubBundle:Language:edit.html.twig', array(
			'language' => $language,
