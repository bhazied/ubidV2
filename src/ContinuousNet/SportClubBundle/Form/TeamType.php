...
class TeamType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('fifaRating', IntegerType::class)
            ->add('fifaRatingMouvement', IntegerType::class)
            ->add('fifaRatingMonth', TextType::class)
            ->add('licensedCount', IntegerType::class)
            ->add('refereesCount', IntegerType::class)
