...
class MenuLinkType extends AbstractType
{
    ...
    {
        $builder
            ->add('menu', EntityType::class, array('expanded' => false, 'multiple' => false, 'class' => 'SportClubBundle:Menu', 'choice_label' => 'name'))
            ...
            ->add('foreignKey', IntegerType::class)
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\SportClubBundle\Entity\MenuLink'
        ));
    }
    ...
    {
        return 'SportClubBundle_MenuLink';
    }
}