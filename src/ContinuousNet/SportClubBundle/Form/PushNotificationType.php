...
class PushNotificationType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('type', ChoiceType::class, array('choices' => array('MatchConfirmed' => 'MatchConfirmed', '30MinutesBefore' => '30MinutesBefore', 'LineUpsConfirmed' => 'LineUpsConfirmed', 'StartHalfTimeFullTime' => 'StartHalfTimeFullTime', 'Goals' => 'Goals', 'Substitutions' => 'Substitutions', 'Promotions' => 'Promotions', 'NewPost' => 'NewPost', 'NewVideo' => 'NewVideo', 'NewAudio' => 'NewAudio', 'NewPhotosGallery' => 'NewPhotosGallery', 'NewArtist' => 'NewArtist', 'NewAlbum' => 'NewAlbum', 'NewAudioCategory' => 'NewAudioCategory', ), 'expanded' => false, 'multiple' => false))
            ->add('category', TextType::class)
            ->add('badge', IntegerType::class)
            ->add('sound', ChoiceType::class, array('choices' => array('notify' => 'notify', 'cliffhanger' => 'cliffhanger', 'jubel' => 'jubel', 'ohhhh' => 'ohhhh', 'trillerpfeife' => 'trillerpfeife', 'pop' => 'pop', 'failure' => 'failure', 'camera_shutter' => 'camera_shutter', ), 'expanded' => false, 'multiple' => false))
            ...
            ->add('artist', EntityType::class, array('expanded' => false, 'multiple' => false, 'class' => 'SportClubBundle:Artist', 'choice_label' => 'name'))
            ->add('album', EntityType::class, array('expanded' => false, 'multiple' => false, 'class' => 'SportClubBundle:Album', 'choice_label' => 'name'))
            ->add('audioCategory', EntityType::class, array('expanded' => false, 'multiple' => false, 'class' => 'SportClubBundle:AudioCategory', 'choice_label' => 'name'))
