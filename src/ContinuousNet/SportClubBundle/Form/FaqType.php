...
class FaqType extends AbstractType
{
    ...
    {
        $builder
            ->add('faqCategory', EntityType::class, array('expanded' => false, 'multiple' => false, 'class' => 'SportClubBundle:FaqCategory', 'choice_label' => 'name'))
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\SportClubBundle\Entity\Faq'
        ));
    }
