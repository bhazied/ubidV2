...
class SharingType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('mode', ChoiceType::class, array('choices' => array('Percentage' => 'Percentage', 'Amount' => 'Amount', ), 'expanded' => false, 'multiple' => false))
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\SportClubBundle\Entity\Sharing'
        ));
    }
    ...
    {
        return 'SportClubBundle_Sharing';
    }
}