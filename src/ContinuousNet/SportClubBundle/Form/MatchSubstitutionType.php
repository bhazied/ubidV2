...
/**
 * Match Substitution Type
 * 
 * Render Match Substitution Type 
 * 
 * PHP version 5.4.4
 * 
...
class MatchSubstitutionType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('playerIn', EntityType::class, array('expanded' => false, 'multiple' => false, 'class' => 'SportClubBundle:Player', 'choice_label' => 'name'))
            ->add('playerOut', EntityType::class, array('expanded' => false, 'multiple' => false, 'class' => 'SportClubBundle:Player', 'choice_label' => 'name'))
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\SportClubBundle\Entity\MatchSubstitution'
        ));
    }
    ...
    {
        return 'SportClubBundle_MatchSubstitution';
    }
}