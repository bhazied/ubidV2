...
class PackageType extends AbstractType
{
    ...
    {
        $builder
            ->add('packageType', EntityType::class, array('expanded' => false, 'multiple' => false, 'class' => 'SportClubBundle:PackageType', 'choice_label' => 'name'))
            ...
            ->add('operatorKey', TextType::class)
            ->add('mode', ChoiceType::class, array('choices' => array('Product' => 'Product', 'Subscription' => 'Subscription', ), 'expanded' => false, 'multiple' => false))
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\SportClubBundle\Entity\Package'
        ));
    }
    ...
    {
        return 'SportClubBundle_Package';
    }
}