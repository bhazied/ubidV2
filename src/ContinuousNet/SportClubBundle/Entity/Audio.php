 ...
 * @access     public
 * 
 * @ORM\Table(name="`audio`", indexes={@ORM\Index(name="audio_type_id", columns={"audio_type_id"}), @ORM\Index(name="price_id", columns={"price_id"}), @ORM\Index(name="sharing_id", columns={"sharing_id"}), @ORM\Index(name="album_id", columns={"album_id"}), @ORM\Index(name="artist_id", columns={"artist_id"}), @ORM\Index(name="creator_user_id", columns={"creator_user_id"}), @ORM\Index(name="modifier_user_id", columns={"modifier_user_id"})})
 * @ORM\Entity
...
class Audio 
{
     ...
     * @access private
     *
     * @ORM\Column(name="`code`", type="string", length=20, nullable=true, unique=false)
     * 
     * @Expose
     * 
     */
     ...
     * @access private
     *
     * @ORM\Column(name="`meta_data`", type="string", length=2000, nullable=true, unique=false)
     * 
     * @Expose
     * 
     */
     ...
     * @access private
     *
     * @ORM\Column(name="`average_ratings`", type="integer", nullable=true, unique=false)
     * 
     * @Expose
     * 
     */
    ...
    /**
     * @var \ContinuousNet\SportClubBundle\Entity\Artist
     * @access private
     *
     ...
     * @access private
     *
     * @ORM\ManyToMany(targetEntity="AudioCategory")
     ...
     *
     * @access public
     * @param \ContinuousNet\SportClubBundle\Entity\Artist $artist
     * @return Audio
     */
     ...
     *
     * @access public
     * @return \ContinuousNet\SportClubBundle\Entity\Artist 
     */
