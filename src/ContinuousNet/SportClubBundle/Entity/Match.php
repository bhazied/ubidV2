...
class Match 
{
     ...
     * @access private
     *
     * @ORM\Column(name="`end_penalty_goals_home`", type="integer", nullable=true, unique=false)
     * 
     * @Expose
     * 
     */
    private $endPenaltyGoalsHome;

    /**
     * @var integer
     * @access private
     *
     * @ORM\Column(name="`end_penalty_goals_away`", type="integer", nullable=true, unique=false)
     * 
     * @Expose
     * 
     */
    private $endPenaltyGoalsAway;
    ...
    /**
     * Set endPenaltyGoalsHome
     *
     * @access public
     * @param integer $endPenaltyGoalsHome
     * @return Match
     */
    public function setEndPenaltyGoalsHome($endPenaltyGoalsHome = null)
    {
        $this->endPenaltyGoalsHome = $endPenaltyGoalsHome;
        return $this;
    }

    /**
     * Get endPenaltyGoalsHome
     *
     * @access public
     * @return integer 
     */
    public function getEndPenaltyGoalsHome()
    {
        return $this->endPenaltyGoalsHome;
    }

    /**
     * Set endPenaltyGoalsAway
     *
     * @access public
     * @param integer $endPenaltyGoalsAway
     * @return Match
     */
    public function setEndPenaltyGoalsAway($endPenaltyGoalsAway = null)
    {
        $this->endPenaltyGoalsAway = $endPenaltyGoalsAway;
        return $this;
    }

    /**
     * Get endPenaltyGoalsAway
     *
     * @access public
     * @return integer 
     */
    public function getEndPenaltyGoalsAway()
    {
        return $this->endPenaltyGoalsAway;
    }
