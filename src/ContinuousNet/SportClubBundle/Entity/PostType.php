 ...
 * Post Type Entity
 * 
 * Storing PostTypes data to the database using Doctrine
 * 
 * PHP version 5.4.4
 * 
 ...
 * @access     public
 * 
 * @ORM\Table(name="`post_type`", indexes={@ORM\Index(name="creator_user_id", columns={"creator_user_id"}), @ORM\Index(name="modifier_user_id", columns={"modifier_user_id"})})
 * @ORM\Entity
 * @UniqueEntity("name")
