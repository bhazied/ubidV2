 ...
 * Season Entity
 * 
 * Storing Seasons data to the database using Doctrine
 * 
 * PHP version 5.4.4
 * 
 ...
 * @access     public
 * 
 * @ORM\Table(name="`season`", indexes={@ORM\Index(name="creator_user_id", columns={"creator_user_id"}), @ORM\Index(name="modifier_user_id", columns={"modifier_user_id"})})
 * @ORM\Entity
...
class Season 
{
     ...
     * @access private
     *
     * @ORM\Column(name="`start_date`", type="date", nullable=false, unique=false)
     * 
     * @Expose
     * 
     */
     ...
     * @access private
     *
     * @ORM\Column(name="`end_date`", type="date", nullable=false, unique=false)
     * 
     * @Expose
     * 
     */
