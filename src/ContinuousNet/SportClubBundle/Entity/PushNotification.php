...
class PushNotification 
{
     ...
     * @access private
     *
     * @ORM\Column(name="`sound`", type="string", nullable=true, unique=false)
     * 
     * @Expose
     * 
     */
     ...
     *
     * @access public
     * @param \ContinuousNet\SportClubBundle\Entity\AudioCategory $audioCategory
     * @return PushNotification
     */
    public function setAudioCategory(AudioCategory $audioCategory = null)
    {
