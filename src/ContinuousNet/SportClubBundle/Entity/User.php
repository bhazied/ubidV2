...
class User  extends BaseUser
{
     ...
     * @access protected
     *
     * @ORM\Column(name="`push_new_artist`", type="boolean", nullable=true, unique=false)
     * 
     * @Expose
     * 
     */
    protected $pushNewArtist;

    /**
     * @var boolean
     * @access protected
     *
     * @ORM\Column(name="`push_new_album`", type="boolean", nullable=true, unique=false)
     * 
     * @Expose
     * 
     */
    protected $pushNewAlbum;

    /**
     * @var boolean
     * @access protected
     *
     * @ORM\Column(name="`push_new_audio_category`", type="boolean", nullable=true, unique=false)
     * 
     * @Expose
     * 
     */
    protected $pushNewAudioCategory;
     ...
     *
     * @access public
     * @param boolean $pushNewArtist
     * @return User
     */
    public function setPushNewArtist($pushNewArtist = null)
    {
        $this->pushNewArtist = $pushNewArtist;
        return $this;
    }
     ...
     * @return boolean 
     */
    public function getPushNewArtist()
    {
        return $this->pushNewArtist;
    }
     ...
     *
     * @access public
     * @param boolean $pushNewAlbum
     * @return User
     */
    public function setPushNewAlbum($pushNewAlbum = null)
    {
        $this->pushNewAlbum = $pushNewAlbum;
        return $this;
    }
     ...
     * @return boolean 
     */
    public function getPushNewAlbum()
    {
        return $this->pushNewAlbum;
    }

    /**
     * Set pushNewAudioCategory
     *
     * @access public
     * @param boolean $pushNewAudioCategory
     * @return User
     */
    public function setPushNewAudioCategory($pushNewAudioCategory = null)
    {
        $this->pushNewAudioCategory = $pushNewAudioCategory;
        return $this;
    }

    /**
     * Get pushNewAudioCategory
     *
     * @access public
     * @return boolean 
     */
    public function getPushNewAudioCategory()
    {
        return $this->pushNewAudioCategory;
    }
