...
class SportEvent 
{
     ...
     * @access private
     *
     * @ORM\Column(name="`enable_audios`", type="boolean", nullable=false, unique=false)
     * 
     * @Expose
     * 
     */
    private $enableAudios;
     ...
     *
     * @access public
     * @param boolean $enableAudios
     * @return SportEvent
     */
    public function setEnableAudios($enableAudios)
    {
        $this->enableAudios = $enableAudios;
        return $this;
    }
     ...
     * @return boolean 
     */
    public function getEnableAudios()
    {
        return $this->enableAudios;
    }
