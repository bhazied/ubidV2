 ...
 * @access     public
 * 
 * @ORM\Table(name="`faq`", indexes={@ORM\Index(name="faq_category_id", columns={"faq_category_id"}), @ORM\Index(name="creator_user_id", columns={"creator_user_id"}), @ORM\Index(name="modifier_user_id", columns={"modifier_user_id"})})
 * @ORM\Entity
...
class Faq 
{
    ...
    /**
     * @var \ContinuousNet\SportClubBundle\Entity\FaqCategory
     * @access private
     *
     ...
     *
     * @access public
     * @param \ContinuousNet\SportClubBundle\Entity\FaqCategory $faqCategory
     * @return Faq
     */
     ...
     *
     * @access public
     * @return \ContinuousNet\SportClubBundle\Entity\FaqCategory 
     */
