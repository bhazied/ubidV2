 ...
 * Match Card Entity
 * 
 * Storing MatchCards data to the database using Doctrine
 * 
 * PHP version 5.4.4
 * 
 ...
 * @access     public
 * 
 * @ORM\Table(name="`match_card`", indexes={@ORM\Index(name="match_id", columns={"match_id"}), @ORM\Index(name="team_id", columns={"team_id"}), @ORM\Index(name="player_id", columns={"player_id"}), @ORM\Index(name="creator_user_id", columns={"creator_user_id"}), @ORM\Index(name="modifier_user_id", columns={"modifier_user_id"})})
 * @ORM\Entity
...
class MatchCard 
{
     ...
     * @access private
     *
     * @ORM\Column(name="card", type="string", nullable=false, unique=false)
     * 
     * @Expose
     * 
     */
